...
namespace VRageMath
{
    ...
    public struct QuaternionD
    {
        ...
        public static QuaternionD operator /(QuaternionD quaternion1, QuaternionD quaternion2)
        {
            ...
            double num4 = quaternion1.W;
            double num5 = 1.0/
                          (quaternion2.X*quaternion2.X + quaternion2.Y*quaternion2.Y + quaternion2.Z*quaternion2.Z +
        ...
        {
            double num = 1.0/
                         Math.Sqrt(quaternion.X*quaternion.X + quaternion.Y*quaternion.Y + quaternion.Z*quaternion.Z +
        ...
        {
            double num1 = amount;
            double d = quaternion1.X*quaternion2.X + quaternion1.Y*quaternion2.Y + quaternion1.Z*quaternion2.Z +
                       quaternion1.W*quaternion2.W;
            bool flag = false;
            if (d < 0.0)
            {
        ...
        public static void Slerp(ref QuaternionD quaternion1, ref QuaternionD quaternion2, double amount,
        ...
        public static QuaternionD Lerp(QuaternionD quaternion1, QuaternionD quaternion2, double amount)
        {
            ...
            QuaternionD quaternionD = new QuaternionD();
            if (quaternion1.X*quaternion2.X + quaternion1.Y*quaternion2.Y + quaternion1.Z*quaternion2.Z +
                quaternion1.W*quaternion2.W >= 0.0)
            {
            ...
            double num3 = 1.0/
                          Math.Sqrt(quaternionD.X*quaternionD.X + quaternionD.Y*quaternionD.Y +
                                    quaternionD.Z*quaternionD.Z + quaternionD.W*quaternionD.W);
            quaternionD.X *= num3;
            quaternionD.Y *= num3;
            quaternionD.Z *= num3;
            quaternionD.W *= num3;
        ...
        public static void Lerp(ref QuaternionD quaternion1, ref QuaternionD quaternion2, double amount,
            out QuaternionD result)
        {
            double num1 = amount;
            double num2 = 1.0 - num1;
