...
namespace VRageMath
{
  ...
  public struct BoundingSphere : IEquatable<BoundingSphere>
  {
    ...
    {
      return (double) Vector3.DistanceSquared(point, this.Center) < (double) this.Radius * (double) this.Radius ? ContainmentType.Contains : ContainmentType.Disjoint;
    }
    ...
    public ContainmentType Contains(BoundingSphere sphere)
    {
      ...
      if ((double) num1 + (double) num2 < (double) result)
        return ContainmentType.Disjoint;
      return (double) num1 - (double) num2 >= (double) result ? ContainmentType.Contains : ContainmentType.Intersects;
    }
