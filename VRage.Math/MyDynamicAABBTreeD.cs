...
namespace VRageMath
{
    public class MyDynamicAABBTreeD
    {
            ...
            else
            {
                ...
                while (!this._nodes[index1].IsLeaf())
                {
                    ...
                    else
                    {
                        ...
                        index1 = (double) (this._nodes[index2].Height + 1)*result1.Perimeter() >=
                                 (double) (this._nodes[index3].Height + 1)*result2.Perimeter()
                            ? index3
                            : index2;
                    }
                }
                ...
                for (int iA = this._nodes[leaf].ParentOrNext; iA != -1; iA = this._nodes[iA].ParentOrNext)
                {
                    ...
                    BoundingBoxD.CreateMerged(ref this._nodes[index2].Aabb, ref this._nodes[index3].Aabb,
        ...
        public int Balance(int iA)
        {
            ...
            if (num > 1)
            {
                ...
                if (dynamicTreeNode4.Height > dynamicTreeNode5.Height)
                {
                    ...
                    BoundingBoxD.CreateMerged(ref dynamicTreeNode2.Aabb, ref dynamicTreeNode5.Aabb,
                        out dynamicTreeNode1.Aabb);
                    BoundingBoxD.CreateMerged(ref dynamicTreeNode1.Aabb, ref dynamicTreeNode4.Aabb,
                ...
                else
                {
                    ...
                    BoundingBoxD.CreateMerged(ref dynamicTreeNode2.Aabb, ref dynamicTreeNode4.Aabb,
                        out dynamicTreeNode1.Aabb);
                    BoundingBoxD.CreateMerged(ref dynamicTreeNode1.Aabb, ref dynamicTreeNode5.Aabb,
                        out dynamicTreeNode3.Aabb);
            ...
            else
            {
                ...
                if (dynamicTreeNode4.Height > dynamicTreeNode5.Height)
                {
                    ...
                    dynamicTreeNode5.ParentOrNext = iA;
                    BoundingBoxD.CreateMerged(ref dynamicTreeNode3.Aabb, ref dynamicTreeNode5.Aabb,
                        out dynamicTreeNode1.Aabb);
                    BoundingBoxD.CreateMerged(ref dynamicTreeNode1.Aabb, ref dynamicTreeNode4.Aabb,
                ...
                else
                {
                    ...
                    dynamicTreeNode4.ParentOrNext = iA;
                    BoundingBoxD.CreateMerged(ref dynamicTreeNode3.Aabb, ref dynamicTreeNode4.Aabb,
                        out dynamicTreeNode1.Aabb);
                    BoundingBoxD.CreateMerged(ref dynamicTreeNode1.Aabb, ref dynamicTreeNode5.Aabb,
                        out dynamicTreeNode2.Aabb);
        ...
        public void OverlapAllFrustum<T>(ref BoundingFrustumD frustum, List<T> elementsList, uint requiredFlags,
            bool clear = true)
        {
            if (clear)
                elementsList.Clear();
        ...
        public void OverlapAllBoundingBox<T>(ref BoundingBoxD bbox, List<T> elementsList, uint requiredFlags = 0U,
            bool clear = true)
        {
            if (clear)
                elementsList.Clear();
        ...
        public void OverlapAllBoundingSphere<T>(ref BoundingSphereD sphere, List<T> overlapElementsList,
            bool clear = true)
        {
            if (clear)
