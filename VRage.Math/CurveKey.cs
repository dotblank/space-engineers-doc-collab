...
namespace VRageMath
{
    ...
    public class CurveKey : IEquatable<CurveKey>, IComparable<CurveKey>
    {
        ...
        public static bool operator !=(CurveKey a, CurveKey b)
        {
            ...
            if (flag1 || flag2)
                return flag1 != flag2;
            if ((double) a.position == (double) b.position && (double) a.internalValue == (double) b.internalValue &&
                ((double) a.tangentIn == (double) b.tangentIn && (double) a.tangentOut == (double) b.tangentOut))
        ...
        {
            if (other != (CurveKey) null && (double) other.position == (double) this.position &&
                ((double) other.internalValue == (double) this.internalValue &&
                 (double) other.tangentIn == (double) this.tangentIn) &&
                (double) other.tangentOut == (double) this.tangentOut)
        ...
        {
            return this.position.GetHashCode() + this.internalValue.GetHashCode() + this.tangentIn.GetHashCode() +
