...
namespace VRageMath
{
    ...
    public struct PlaneD : IEquatable<PlaneD>
    {
        ...
        public static PlaneD Transform(PlaneD PlaneD, Matrix matrix)
        {
            ...
            PlaneD planeD;
            planeD.Normal.X = num1*(double) result.M11 + num2*(double) result.M12 + num3*(double) result.M13 +
                              num4*(double) result.M14;
            planeD.Normal.Y = num1*(double) result.M21 + num2*(double) result.M22 + num3*(double) result.M23 +
                              num4*(double) result.M24;
            planeD.Normal.Z = num1*(double) result.M31 + num2*(double) result.M32 + num3*(double) result.M33 +
                              num4*(double) result.M34;
            planeD.D = num1*(double) result.M41 + num2*(double) result.M42 + num3*(double) result.M43 +
                       num4*(double) result.M44;
            return planeD;
        }
        ...
        public static void Transform(ref PlaneD PlaneD, ref Matrix matrix, out PlaneD result)
        {
            ...
            double num3 = PlaneD.Normal.Z;
            double num4 = PlaneD.D;
            result.Normal.X = num1*(double) result1.M11 + num2*(double) result1.M12 + num3*(double) result1.M13 +
                              num4*(double) result1.M14;
            result.Normal.Y = num1*(double) result1.M21 + num2*(double) result1.M22 + num3*(double) result1.M23 +
                              num4*(double) result1.M24;
            result.Normal.Z = num1*(double) result1.M31 + num2*(double) result1.M32 + num3*(double) result1.M33 +
                              num4*(double) result1.M34;
            result.D = num1*(double) result1.M41 + num2*(double) result1.M42 + num3*(double) result1.M43 +
                       num4*(double) result1.M44;
        }
        ...
        {
            return this.Normal.X*(double) value.X + this.Normal.Y*(double) value.Y + this.Normal.Z*(double) value.Z +
                   this.D*(double) value.W;
        }

        public void Dot(ref Vector4 value, out double result)
        {
            result = this.Normal.X*(double) value.X + this.Normal.Y*(double) value.Y + this.Normal.Z*(double) value.Z +
                     this.D*(double) value.W;
        }
        ...
        public PlaneIntersectionType Intersects(BoundingBoxD box)
        {
            ...
            return this.Normal.X*vector3D2.X + this.Normal.Y*vector3D2.Y + this.Normal.Z*vector3D2.Z + this.D >= 0.0
        ...
        {
            double num = sphere.Center.X*this.Normal.X + sphere.Center.Y*this.Normal.Y + sphere.Center.Z*this.Normal.Z +
                         this.D;
        ...
        {
            double num = (double) sphere.Center.X*this.Normal.X + (double) sphere.Center.Y*this.Normal.Y +
                         (double) sphere.Center.Z*this.Normal.Z + this.D;
