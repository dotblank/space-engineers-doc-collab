...
namespace VRageMath
{
    ...
    public struct Quaternion : IEquatable<Quaternion>
    {
        ...
        public static Quaternion operator *(Quaternion quaternion1, Quaternion quaternion2)
        {
            ...
            float num12 =
                (float) ((double) num1*(double) num5 + (double) num2*(double) num6 + (double) num3*(double) num7);
            Quaternion quaternion;
        ...
        public static Quaternion operator /(Quaternion quaternion1, Quaternion quaternion2)
        {
            ...
            float num5 = 1f/
                         (float)
                             ((double) quaternion2.X*(double) quaternion2.X +
            ...
            float num13 =
                (float) ((double) num1*(double) num6 + (double) num2*(double) num7 + (double) num3*(double) num8);
            Quaternion quaternion;
        ...
        public void GetAxisAngle(out Vector3 axis, out float angle)
        {
            ...
            angle = (float) Math.Atan2((double) num1, (double) num2)*2f;
        }
        ...
        public static Quaternion Normalize(Quaternion quaternion)
        {
            float num = 1f/
                        (float)
                            Math.Sqrt((double) quaternion.X*(double) quaternion.X +
        ...
        public static Quaternion Inverse(Quaternion quaternion)
        {
            float num = 1f/
                        (float)
                            ((double) quaternion.X*(double) quaternion.X + (double) quaternion.Y*(double) quaternion.Y +
        ...
        public static Quaternion CreateFromYawPitchRoll(float yaw, float pitch, float roll)
        {
            ...
            Quaternion quaternion;
            quaternion.X =
                (float) ((double) num9*(double) num5*(double) num3 + (double) num8*(double) num6*(double) num2);
            quaternion.Y =
                (float) ((double) num8*(double) num6*(double) num3 - (double) num9*(double) num5*(double) num2);
            quaternion.Z =
                (float) ((double) num9*(double) num6*(double) num2 - (double) num8*(double) num5*(double) num3);
            quaternion.W =
                (float) ((double) num9*(double) num6*(double) num3 + (double) num8*(double) num5*(double) num2);
            return quaternion;
        }
        ...
        public static Quaternion CreateFromForwardUp(Vector3 forward, Vector3 up)
        {
            ...
            float num1 = vector2.X;
            float num2 = vector2.Y;
            float num3 = vector2.Z;
            float num4 = vector3_2.X;
            float num5 = vector3_2.Y;
            float num6 = vector3_2.Z;
            float num7 = vector3_1.X;
            float num8 = vector3_1.Y;
            float num9 = vector3_1.Z;
            float num10 = num1 + num5 + num9;
            Quaternion quaternion = new Quaternion();
            if ((double) num10 > 0.0)
            {
                float num11 = (float) Math.Sqrt((double) num10 + 1.0);
                quaternion.W = num11*0.5f;
                float num12 = 0.5f/num11;
                quaternion.X = (num6 - num8)*num12;
                quaternion.Y = (num7 - num3)*num12;
                quaternion.Z = (num2 - num4)*num12;
                return quaternion;
            }
            else if ((double) num1 >= (double) num5 && (double) num1 >= (double) num9)
            {
                float num11 = (float) Math.Sqrt(1.0 + (double) num1 - (double) num5 - (double) num9);
                float num12 = 0.5f/num11;
                quaternion.X = 0.5f*num11;
                quaternion.Y = (num2 + num4)*num12;
                quaternion.Z = (num3 + num7)*num12;
                quaternion.W = (num6 - num8)*num12;
                return quaternion;
            }
            else if ((double) num5 > (double) num9)
            {
                float num11 = (float) Math.Sqrt(1.0 + (double) num5 - (double) num1 - (double) num9);
                float num12 = 0.5f/num11;
                quaternion.X = (num4 + num2)*num12;
                quaternion.Y = 0.5f*num11;
                quaternion.Z = (num8 + num6)*num12;
                quaternion.W = (num7 - num3)*num12;
                return quaternion;
            }
            else
            {
                float num11 = (float) Math.Sqrt(1.0 + (double) num9 - (double) num1 - (double) num5);
                float num12 = 0.5f/num11;
                quaternion.X = (num7 + num3)*num12;
                quaternion.Y = (num8 + num6)*num12;
                quaternion.Z = 0.5f*num11;
                quaternion.W = (num2 - num4)*num12;
                return quaternion;
            }
        }
        ...
        public static float Dot(Quaternion quaternion1, Quaternion quaternion2)
        {
            return
                (float)
                    ((double) quaternion1.X*(double) quaternion2.X + (double) quaternion1.Y*(double) quaternion2.Y +
            ...
            out Quaternion result)
        {
            ...
            float num3 = 1f/
                         (float)
                             Math.Sqrt((double) result.X*(double) result.X + (double) result.Y*(double) result.Y +
        ...
        {
            return Quaternion.IsZero(value, 0.0001f);
        }
        ...
        public static bool IsZero(Quaternion value, float epsilon)
        {
            if ((double) Math.Abs(value.X) < (double) epsilon && (double) Math.Abs(value.Y) < (double) epsilon &&
                (double) Math.Abs(value.Z) < (double) epsilon)
                return (double) Math.Abs(value.W) < (double) epsilon;
            else
                return false;
        }
    }
