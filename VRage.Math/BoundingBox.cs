...
namespace VRageMath
{
    ...
    public struct BoundingBox : IEquatable<BoundingBox>
    {
        ...
        [ProtoMember(1)] public Vector3 Min;
        [ProtoMember(2)] public Vector3 Max;

        public Vector3 Center
        {
            get { return (this.Min + this.Max)/2f; }
        }

        public Vector3 HalfExtents
        {
            get { return (this.Max - this.Min)/2f; }
        }
        ...
        public bool Intersects(ref BoundingBox box)
        {
            if ((double) this.Max.X >= (double) box.Min.X && (double) this.Min.X <= (double) box.Max.X &&
                ...
                (double) this.Max.Z >= (double) box.Min.Z)
        ...
        public bool IntersectsTriangle(ref Vector3 v0, ref Vector3 v1, ref Vector3 v2)
        {
            ...
            if ((double) result1.X > (double) this.Max.X || (double) result2.X < (double) this.Min.X ||
                ((double) result1.Y > (double) this.Max.Y || (double) result2.Y < (double) this.Min.Y) ||
                ((double) result1.Z > (double) this.Max.Z || (double) result2.Z < (double) this.Min.Z))
                return false;
            ...
            float num1 =
                (float)
                    ((double) halfExtents.Y*(double) Math.Abs(vector1.Z) +
                     (double) halfExtents.Z*(double) Math.Abs(vector1.Y));
            float val1_1 = (float) ((double) v0.Z*(double) v1.Y - (double) v0.Y*(double) v1.Z);
            float val2_1 = (float) ((double) v2.Z*(double) vector1.Y - (double) v2.Y*(double) vector1.Z);
            if ((double) Math.Min(val1_1, val2_1) > (double) num1 || (double) Math.Max(val1_1, val2_1) < -(double) num1)
                return false;
            float num2 =
                (float)
                    ((double) halfExtents.X*(double) Math.Abs(vector1.Z) +
                     (double) halfExtents.Z*(double) Math.Abs(vector1.X));
            float val1_2 = (float) ((double) v0.X*(double) v1.Z - (double) v0.Z*(double) v1.X);
            float val2_2 = (float) ((double) v2.X*(double) vector1.Z - (double) v2.Z*(double) vector1.X);
            if ((double) Math.Min(val1_2, val2_2) > (double) num2 || (double) Math.Max(val1_2, val2_2) < -(double) num2)
                return false;
            float num3 =
                (float)
                    ((double) halfExtents.X*(double) Math.Abs(vector1.Y) +
                     (double) halfExtents.Y*(double) Math.Abs(vector1.X));
            float val1_3 = (float) ((double) v0.Y*(double) v1.X - (double) v0.X*(double) v1.Y);
            float val2_3 = (float) ((double) v2.Y*(double) vector1.X - (double) v2.X*(double) vector1.Y);
            if ((double) Math.Min(val1_3, val2_3) > (double) num3 || (double) Math.Max(val1_3, val2_3) < -(double) num3)
                return false;
            float num4 =
                (float)
                    ((double) halfExtents.Y*(double) Math.Abs(vector2.Z) +
                     (double) halfExtents.Z*(double) Math.Abs(vector2.Y));
            float val1_4 = (float) ((double) v1.Z*(double) v2.Y - (double) v1.Y*(double) v2.Z);
            float val2_4 = (float) ((double) v0.Z*(double) vector2.Y - (double) v0.Y*(double) vector2.Z);
            if ((double) Math.Min(val1_4, val2_4) > (double) num4 || (double) Math.Max(val1_4, val2_4) < -(double) num4)
                return false;
            float num5 =
                (float)
                    ((double) halfExtents.X*(double) Math.Abs(vector2.Z) +
                     (double) halfExtents.Z*(double) Math.Abs(vector2.X));
            float val1_5 = (float) ((double) v1.X*(double) v2.Z - (double) v1.Z*(double) v2.X);
            float val2_5 = (float) ((double) v0.X*(double) vector2.Z - (double) v0.Z*(double) vector2.X);
            if ((double) Math.Min(val1_5, val2_5) > (double) num5 || (double) Math.Max(val1_5, val2_5) < -(double) num5)
                return false;
            float num6 =
                (float)
                    ((double) halfExtents.X*(double) Math.Abs(vector2.Y) +
                     (double) halfExtents.Y*(double) Math.Abs(vector2.X));
            float val1_6 = (float) ((double) v1.Y*(double) v2.X - (double) v1.X*(double) v2.Y);
            float val2_6 = (float) ((double) v0.Y*(double) vector2.X - (double) v0.X*(double) vector2.Y);
            if ((double) Math.Min(val1_6, val2_6) > (double) num6 || (double) Math.Max(val1_6, val2_6) < -(double) num6)
                return false;
            float num7 =
                (float)
                    ((double) halfExtents.Y*(double) Math.Abs(vector3.Z) +
                     (double) halfExtents.Z*(double) Math.Abs(vector3.Y));
            float val1_7 = (float) ((double) v2.Z*(double) v0.Y - (double) v2.Y*(double) v0.Z);
            float val2_7 = (float) ((double) v1.Z*(double) vector3.Y - (double) v1.Y*(double) vector3.Z);
            if ((double) Math.Min(val1_7, val2_7) > (double) num7 || (double) Math.Max(val1_7, val2_7) < -(double) num7)
                return false;
            float num8 =
                (float)
                    ((double) halfExtents.X*(double) Math.Abs(vector3.Z) +
                     (double) halfExtents.Z*(double) Math.Abs(vector3.X));
            float val1_8 = (float) ((double) v2.X*(double) v0.Z - (double) v2.Z*(double) v0.X);
            float val2_8 = (float) ((double) v1.X*(double) vector3.Z - (double) v1.Z*(double) vector3.X);
            if ((double) Math.Min(val1_8, val2_8) > (double) num8 || (double) Math.Max(val1_8, val2_8) < -(double) num8)
                return false;
            float num9 =
                (float)
                    ((double) halfExtents.X*(double) Math.Abs(vector3.Y) +
                     (double) halfExtents.Y*(double) Math.Abs(vector3.X));
            float val1_9 = (float) ((double) v2.Y*(double) v0.X - (double) v2.X*(double) v0.Y);
            float val2_9 = (float) ((double) v1.Y*(double) vector3.X - (double) v1.X*(double) vector3.Y);
            return (double) Math.Min(val1_9, val2_9) <= (double) num9 &&
                   (double) Math.Max(val1_9, val2_9) >= -(double) num9;
        }
        ...
        public PlaneIntersectionType Intersects(Plane plane)
        {
            ...
            if ((double) plane.Normal.X*(double) vector3_1.X + (double) plane.Normal.Y*(double) vector3_1.Y +
                (double) plane.Normal.Z*(double) vector3_1.Z + (double) plane.D > 0.0)
                return PlaneIntersectionType.Front;
            return (double) plane.Normal.X*(double) vector3_2.X + (double) plane.Normal.Y*(double) vector3_2.Y +
                   (double) plane.Normal.Z*(double) vector3_2.Z + (double) plane.D >= 0.0
        ...
        public void Intersects(ref Plane plane, out PlaneIntersectionType result)
        {
            ...
            else if ((double) plane.Normal.X*(double) vector3_2.X + (double) plane.Normal.Y*(double) vector3_2.Y +
                     (double) plane.Normal.Z*(double) vector3_2.Z + (double) plane.D < 0.0)
        ...
        public void Contains(ref BoundingBox box, out ContainmentType result)
        {
            ...
            if ((double) this.Max.X < (double) box.Min.X || (double) this.Min.X > (double) box.Max.X ||
                ...
                ((double) this.Max.Z < (double) box.Min.Z || (double) this.Min.Z > (double) box.Max.Z))
                return;
            result = (double) this.Min.X > (double) box.Min.X || (double) box.Max.X > (double) this.Max.X ||
                     ((double) this.Min.Y > (double) box.Min.Y || (double) box.Max.Y > (double) this.Max.Y) ||
                     ((double) this.Min.Z > (double) box.Min.Z || (double) box.Max.Z > (double) this.Max.Z)
                ? ContainmentType.Intersects
                : ContainmentType.Contains;
        ...
        {
            return (double) this.Min.X <= point.X && point.X <= (double) this.Max.X &&
                   ((double) this.Min.Y <= point.Y && point.Y <= (double) this.Max.Y) &&
                   ((double) this.Min.Z <= point.Z && point.Z <= (double) this.Max.Z)
                ? ContainmentType.Contains
                : ContainmentType.Disjoint;
        }
        ...
        {
            result = (double) this.Min.X > (double) point.X || (double) point.X > (double) this.Max.X ||
                     ((double) this.Min.Y > (double) point.Y || (double) point.Y > (double) this.Max.Y) ||
                     ((double) this.Min.Z > (double) point.Z || (double) point.Z > (double) this.Max.Z)
                ? ContainmentType.Disjoint
                : ContainmentType.Contains;
        ...
        public float SurfaceArea()
        {
            ...
            return
                (float)
                    (2.0*
                     ((double) vector3.X*(double) vector3.Y + (double) vector3.X*(double) vector3.Z +
                      (double) vector3.Y*(double) vector3.Z));
        }
        ...
        public float Perimeter()
        {
            return
                (float)
                    (4.0*
                     ((double) (this.Max.X - this.Min.X) + (double) (this.Max.Y - this.Min.Y) +
                      (double) (this.Max.Z - this.Min.Z)));
        }
