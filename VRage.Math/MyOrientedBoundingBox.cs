...
namespace VRageMath
{
    public struct MyOrientedBoundingBox : IEquatable<MyOrientedBoundingBox>
    {
        ...
        {
            return new MyOrientedBoundingBox(Vector3.Transform(this.Center, rotation) + translation, this.HalfExtent,
                this.Orientation*rotation);
        }

        public MyOrientedBoundingBox Transform(float scale, Quaternion rotation, Vector3 translation)
        {
            return new MyOrientedBoundingBox(Vector3.Transform(this.Center*scale, rotation) + translation,
                this.HalfExtent*scale, this.Orientation*rotation);
        }
        ...
        public bool Intersects(ref BoundingBox box)
        {
            ...
            return MyOrientedBoundingBox.ContainsRelativeBox(ref hA, ref this.HalfExtent, ref fromQuaternion) !=
        ...
        public ContainmentType Contains(ref MyOrientedBoundingBox other)
        {
            ...
            return MyOrientedBoundingBox.ContainsRelativeBox(ref this.HalfExtent, ref other.HalfExtent,
                ref fromQuaternion);
        }
        ...
        public ContainmentType Contains(ref BoundingSphere sphere)
        {
            ...
            if ((double) val1_1 <= -(double) num1 && (double) val1_2 <= -(double) num1 &&
                (double) val1_3 <= -(double) num1)
                return ContainmentType.Contains;
            float num2 = Math.Max(val1_1, 0.0f);
            float num3 = Math.Max(val1_2, 0.0f);
            float num4 = Math.Max(val1_3, 0.0f);
            return (double) num2*(double) num2 + (double) num3*(double) num3 + (double) num4*(double) num4 >=
        ...
        public bool Contains(ref Vector3 point)
        {
            ...
            if ((double) Math.Abs(vector3.X) <= (double) this.HalfExtent.X &&
                (double) Math.Abs(vector3.Y) <= (double) this.HalfExtent.Y)
        ...
        public float? Intersects(ref Ray ray)
        {
            ...
            {
                if (-(double) num3 - (double) this.HalfExtent.X > 0.0 ||
                    -(double) num3 + (double) this.HalfExtent.X < 0.0)
                    return new float?();
            }
            else
            {
            ...
            {
                if (-(double) num8 - (double) this.HalfExtent.Y > 0.0 ||
                    -(double) num8 + (double) this.HalfExtent.Y < 0.0)
                    return new float?();
            }
            else
            {
            ...
            {
                if (-(double) num10 - (double) this.HalfExtent.Z > 0.0 ||
                    -(double) num10 + (double) this.HalfExtent.Z < 0.0)
                    return new float?();
            }
            else
            {
        ...
        public PlaneIntersectionType Intersects(ref Plane plane)
        {
            ...
            float num2 = Math.Abs(this.HalfExtent.X*vector3.X) + Math.Abs(this.HalfExtent.Y*vector3.Y) +
                         Math.Abs(this.HalfExtent.Z*vector3.Z);
        ...
        public static ContainmentType ContainsRelativeBox(ref Vector3 hA, ref Vector3 hB, ref Matrix mB)
        {
            ...
            if ((double) vector3_1.X + (double) num1 <= (double) hA.X &&
                (double) vector3_1.Y + (double) num2 <= (double) hA.Y &&
                (double) vector3_1.Z + (double) num3 <= (double) hA.Z)
                return ContainmentType.Contains;
            if ((double) vector3_1.X >=
                (double) hA.X + (double) Math.Abs(vector2_1.X) + (double) Math.Abs(vector2_2.X) +
                (double) Math.Abs(vector2_3.X) ||
                (double) vector3_1.Y >=
                (double) hA.Y + (double) Math.Abs(vector2_1.Y) + (double) Math.Abs(vector2_2.Y) +
                (double) Math.Abs(vector2_3.Y) ||
                ((double) vector3_1.Z >=
                 (double) hA.Z + (double) Math.Abs(vector2_1.Z) + (double) Math.Abs(vector2_2.Z) +
                 (double) Math.Abs(vector2_3.Z) ||
                 (double) Math.Abs(Vector3.Dot(translation, right)) >=
                 (double) Math.Abs(hA.X*right.X) + (double) Math.Abs(hA.Y*right.Y) + (double) Math.Abs(hA.Z*right.Z) +
                 (double) hB.X) ||
                ((double) Math.Abs(Vector3.Dot(translation, up)) >=
                 (double) Math.Abs(hA.X*up.X) + (double) Math.Abs(hA.Y*up.Y) + (double) Math.Abs(hA.Z*up.Z) +
                 (double) hB.Y ||
                 (double) Math.Abs(Vector3.Dot(translation, backward)) >=
                 (double) Math.Abs(hA.X*backward.X) + (double) Math.Abs(hA.Y*backward.Y) +
                 (double) Math.Abs(hA.Z*backward.Z) + (double) hB.Z))
                return ContainmentType.Disjoint;
            Vector3 vector3_2 = new Vector3(0.0f, -right.Z, right.Y);
            if ((double) Math.Abs(Vector3.Dot(translation, vector3_2)) >=
                (double) Math.Abs(hA.Y*vector3_2.Y) + (double) Math.Abs(hA.Z*vector3_2.Z) +
                (double) Math.Abs(Vector3.Dot(vector3_2, vector2_2)) +
                (double) Math.Abs(Vector3.Dot(vector3_2, vector2_3)))
                return ContainmentType.Disjoint;
            vector3_2 = new Vector3(0.0f, -up.Z, up.Y);
            if ((double) Math.Abs(Vector3.Dot(translation, vector3_2)) >=
                (double) Math.Abs(hA.Y*vector3_2.Y) + (double) Math.Abs(hA.Z*vector3_2.Z) +
                (double) Math.Abs(Vector3.Dot(vector3_2, vector2_3)) +
                (double) Math.Abs(Vector3.Dot(vector3_2, vector2_1)))
                return ContainmentType.Disjoint;
            ...
            if ((double) Math.Abs(Vector3.Dot(translation, vector3_2)) >=
                (double) Math.Abs(hA.Z*vector3_2.Z) + (double) Math.Abs(hA.X*vector3_2.X) +
                (double) Math.Abs(Vector3.Dot(vector3_2, vector2_2)) +
                (double) Math.Abs(Vector3.Dot(vector3_2, vector2_3)))
                return ContainmentType.Disjoint;
            ...
            if ((double) Math.Abs(Vector3.Dot(translation, vector3_2)) >=
                (double) Math.Abs(hA.X*vector3_2.X) + (double) Math.Abs(hA.Y*vector3_2.Y) +
                (double) Math.Abs(Vector3.Dot(vector3_2, vector2_2)) +
                (double) Math.Abs(Vector3.Dot(vector3_2, vector2_3)))
                return ContainmentType.Disjoint;
            ...
            return (double) Math.Abs(Vector3.Dot(translation, vector3_2)) >=
                   (double) Math.Abs(hA.X*vector3_2.X) + (double) Math.Abs(hA.Y*vector3_2.Y) +
                   (double) Math.Abs(Vector3.Dot(vector3_2, vector2_1)) +
                   (double) Math.Abs(Vector3.Dot(vector3_2, vector2_2))
                ? ContainmentType.Disjoint
        ...
        {
            return
                MyOrientedBoundingBox.CreateFromBoundingBox(new BoundingBox(-boundingBox.Size()/2f,
                    boundingBox.Size()/2f)).Transform(matrix);
        }
    }
}