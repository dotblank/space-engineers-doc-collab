...
namespace VRageMath
{
    ...
    {
        public static readonly MyBlockOrientation Identity = new MyBlockOrientation(Base6Directions.Direction.Forward,
        ...
        {
            get { return Base6Directions.GetLeft(this.Up, this.Forward); }
        }

        public bool IsValid
        {
            get { return Base6Directions.IsValidBlockOrientation(this.Forward, this.Up); }
        }
        ...
        public Base6Directions.Direction TransformDirectionInverse(Base6Directions.Direction baseDirection)
        {
            ...
            if (axis == Base6Directions.GetAxis(this.Forward))
                return baseDirection != this.Forward
