...
namespace VRageMath
{
    ...
    public struct Vector3B
    {
        ...
        [ProtoMember(1)] public sbyte X;
        [ProtoMember(2)] public sbyte Y;
        [ProtoMember(3)] public sbyte Z;
        ...
        {
            return new Vector3B((sbyte) Math.Round((double) vec.X), (sbyte) Math.Round((double) vec.Y),
                (sbyte) Math.Round((double) vec.Z));
        }
