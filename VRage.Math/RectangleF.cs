...
namespace VRageMath
{
  ...
  public struct RectangleF : IEquatable<RectangleF>
  {
    ...
    {
      return (double) x >= (double) this.X && (double) x <= (double) this.X + (double) this.Width && ((double) y >= (double) this.Y && (double) y <= (double) this.Y + (double) this.Height);
    }
    ...
    {
      return (double) vector2D.X >= (double) this.X && (double) vector2D.X <= (double) this.X + (double) this.Width && ((double) vector2D.Y >= (double) this.Y && (double) vector2D.Y <= (double) this.Y + (double) this.Height);
    }

    public bool Contains(Point point)
    {
      return (double) point.X >= (double) this.X && (double) point.X <= (double) this.X + (double) this.Width && ((double) point.Y >= (double) this.Y && (double) point.Y <= (double) this.Y + (double) this.Height);
    }
