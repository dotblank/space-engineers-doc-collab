...
namespace VRageMath
{
  ...
  public struct Vector3Ushort
  {
    ...
    {
      return new Vector3Ushort((ushort) ((uint) t * (uint) v.X), (ushort) ((uint) t * (uint) v.Y), (ushort) ((uint) t * (uint) v.Z));
    }
    ...
    {
      return new Vector3((float) ushortVector.X * vector.X, (float) ushortVector.Y * vector.Y, (float) ushortVector.Z * vector.Z);
    }
