...
namespace VRageMath
{
    ...
    public struct Ray : IEquatable<Ray>
    {
        ...
        {
            if ((double) this.Position.X == (double) other.Position.X &&
        ...
        public float? Intersects(Plane plane)
        {
            float num1 =
                (float)
                    ((double) plane.Normal.X*(double) this.Direction.X +
            ...
            float num2 =
                (float)
                    ((double) plane.Normal.X*(double) this.Position.X + (double) plane.Normal.Y*(double) this.Position.Y +
        ...
        public void Intersects(ref Plane plane, out float? result)
        {
            ...
            else
            {
                float num2 =
                    (float)
                        ((double) plane.Normal.X*(double) this.Position.X +
        ...
        public float? Intersects(BoundingSphere sphere)
        {
            ...
            float num6 =
                (float)
                    ((double) num1*(double) this.Direction.X + (double) num2*(double) this.Direction.Y +
