...
namespace VRageMath
{
    ...
    public struct Vector3I : IEquatable<Vector3I>, IComparable<Vector3I>
    {
        ...
        {
            return new Vector3I((int) Math.Floor((double) value.X), (int) Math.Floor((double) value.Y),
                (int) Math.Floor((double) value.Z));
        }
        ...
        {
            return new Vector3I((int) Math.Ceiling((double) value.X), (int) Math.Ceiling((double) value.Y),
        ...
        {
            int num1 = position.X*(int) Math.Round((double) matrix.M11) +
                       position.Y*(int) Math.Round((double) matrix.M21) +
                       position.Z*(int) Math.Round((double) matrix.M31) + (int) Math.Round((double) matrix.M41);
            int num2 = position.X*(int) Math.Round((double) matrix.M12) +
                       position.Y*(int) Math.Round((double) matrix.M22) +
                       position.Z*(int) Math.Round((double) matrix.M32) + (int) Math.Round((double) matrix.M42);
            int num3 = position.X*(int) Math.Round((double) matrix.M13) +
                       position.Y*(int) Math.Round((double) matrix.M23) +
                       position.Z*(int) Math.Round((double) matrix.M33) + (int) Math.Round((double) matrix.M43);
            result.X = num1;
            result.Y = num2;
            result.Z = num3;
        }
        ...
        public static void Transform(ref Vector3I value, ref MatrixI matrix, out Vector3I result)
        {
            result = value.X*Base6Directions.GetIntVector(matrix.Right) +
                     ...
                     value.Z*Base6Directions.GetIntVector(matrix.Backward) + matrix.Translation;
        }
        ...
        {
            int num1 = normal.X*(int) Math.Round((double) matrix.M11) + normal.Y*(int) Math.Round((double) matrix.M21) +
                       normal.Z*(int) Math.Round((double) matrix.M31);
            int num2 = normal.X*(int) Math.Round((double) matrix.M12) + normal.Y*(int) Math.Round((double) matrix.M22) +
                       normal.Z*(int) Math.Round((double) matrix.M32);
            int num3 = normal.X*(int) Math.Round((double) matrix.M13) + normal.Y*(int) Math.Round((double) matrix.M23) +
                       normal.Z*(int) Math.Round((double) matrix.M33);
            result.X = num1;
            result.Y = num2;
            result.Z = num3;
        }
