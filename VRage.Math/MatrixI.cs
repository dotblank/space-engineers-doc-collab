...
namespace VRageMath
{
    public struct MatrixI
    {
        ...
        {
            this = new MatrixI(ref position, Base6Directions.GetDirection(ref forward),
                Base6Directions.GetDirection(ref up));
        }
        ...
        {
            return Matrix.CreateWorld(new Vector3(this.Translation), Base6Directions.GetVector(this.Forward),
                Base6Directions.GetVector(this.Up));
        }

        public static MatrixI CreateRotation(Base6Directions.Direction oldA, Base6Directions.Direction oldB,
            Base6Directions.Direction newA, Base6Directions.Direction newB)
        {
