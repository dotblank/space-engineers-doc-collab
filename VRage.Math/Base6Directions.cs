...
namespace VRageMath
{
    public static class Base6Directions
    {
        ...
        {
            return Base6Directions.GetAxis(dir) == Base6Directions.Axis.UpDown
                ? Base6Directions.Direction.Right
                : Base6Directions.Direction.Up;
        }
        ...
        public static Base6Directions.Direction GetDirection(ref Vector3 vec)
        {
            return
                (Base6Directions.Direction)
                    (0 + Base6Directions.ForwardBackward[(int) Math.Round((double) vec.Z + 1.0)] +
                     Base6Directions.LeftRight[(int) Math.Round((double) vec.X + 1.0)] +
                     Base6Directions.UpDown[(int) Math.Round((double) vec.Y + 1.0)]);
        }
        ...
        public static Base6Directions.Direction GetDirection(ref Vector3I vec)
        {
            return
                (Base6Directions.Direction)
                    (0 + Base6Directions.ForwardBackward[vec.Z + 1] + Base6Directions.LeftRight[vec.X + 1] +
                     Base6Directions.UpDown[vec.Y + 1]);
        }
