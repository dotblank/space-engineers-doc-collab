...
namespace VRageMath
{
    ...
    public struct BoundingSphereD : IEquatable<BoundingSphereD>
    {
        ...
        public static void CreateMerged(ref BoundingSphereD original, ref BoundingSphereD additional,
        ...
        {
            return Vector3D.DistanceSquared(point, this.Center) < this.Radius*this.Radius
        ...
        public void Contains(ref BoundingSphereD sphere, out ContainmentType result)
        {
            ...
            double num1 = this.Radius;
            double num2 = sphere.Radius;
            result = num1 + num2 >= result1
                ? (num1 - num2 >= result1 ? ContainmentType.Contains : ContainmentType.Intersects)
                : ContainmentType.Disjoint;
        }
        ...
        public BoundingSphereD Transform(MatrixD matrix)
        {
            ...
            double d = Math.Max(matrix.M11*matrix.M11 + matrix.M12*matrix.M12 + matrix.M13*matrix.M13,
