...
namespace Sandbox.Common.Components
{
    public abstract class MyRenderComponentBase : MyComponentBase
    {
        ...
        {
            get { return this.m_enableColorMaskHsv; }
            set
            {
        ...
        {
            get { return this.m_colorMaskHsv; }
            set
            {
        ...
        {
            get { return this.m_renderObjectIDs; }
        }

        public bool Visible
        {
            get { return (this.Entity.Flags & EntityFlags.Visible) != (EntityFlags) 0; }
            set
            {
        ...
        {
            get { return (this.Entity.Flags & EntityFlags.Near) != (EntityFlags) 0; }
            set
            {
                ...
                foreach (MyHierarchyComponentBase hierarchyComponentBase in this.Entity.Hierarchy.Children)
                {
                    ...
                    if (hierarchyComponentBase.Entity.InScene &&
                        hierarchyComponentBase.CurrentContainer.TryGet<MyRenderComponentBase>(out component))
        ...
        {
            get { return (this.Entity.Flags & EntityFlags.NeedsDrawFromParent) != (EntityFlags) 0; }
            set
            {
        ...
        {
            get { return (this.Entity.Flags & EntityFlags.NeedsResolveCastShadow) != (EntityFlags) 0; }
            set
            {
                if (value)
        ...
        {
            get { return (this.Entity.Flags & EntityFlags.FastCastShadowResolve) != (EntityFlags) 0; }
            set
            {
                if (value)
        ...
        {
            get { return (this.Entity.Flags & EntityFlags.SkipIfTooSmall) != (EntityFlags) 0; }
            set
            {
                if (value)
        ...
        {
            get { return (this.Entity.Flags & EntityFlags.ShadowBoxLod) != (EntityFlags) 0; }
            set
            {
                if (value)
        ...
        {
            get { return (this.Entity.Flags & EntityFlags.NeedsDraw) != (EntityFlags) 0; }
            set
            {
        ...
        public virtual void InvalidateRenderObjects(bool sortIntoCullobjects = false)
        {
            ...
            if (!this.Entity.Visible && !this.Entity.CastShadows ||
                (!this.Entity.InScene || !this.Entity.InvalidateOnMove))
                return;
        ...
        public void UpdateRenderEntity(Vector3 colorMaskHSV)
        {
            ...
            MyRenderProxy.UpdateRenderEntity(this.m_renderObjectIDs[0], new Color?(this.m_diffuseColor),
                new Vector3?(this.m_colorMaskHsv), 0.0f);
        }
        ...
        public void UpdateRenderObject(bool visible)
        {
            ...
            if (visible)
            {
                ...
                if (this.Visible && (hierarchy.Parent == null || hierarchy.Parent.Entity.Visible) &&
                    this.CanBeAddedToRender())
                {
