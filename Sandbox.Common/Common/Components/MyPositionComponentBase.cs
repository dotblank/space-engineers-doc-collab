...
namespace Sandbox.Common.Components
{
  public abstract class MyPositionComponentBase : MyComponentBase
  {
    ...
    public MatrixD WorldMatrix
    {
      ...
      set
      {
        this.SetWorldMatrix(value, (object) null);
      }
    }
    ...
    public Matrix LocalMatrix
    {
      get
      {
        return (Matrix) this.m_localMatrix;
      }
      set
      {
        this.SetLocalMatrix((MatrixD) value, (object) null);
      }
    }
    ...
    protected virtual bool ShouldSync
    {
      get
      {
        return this.CurrentContainer.Get<MySyncComponentBase>() != null;
      }
    }
    ...
    public float? Scale
    {
      ...
      set
      {
        ...
        if (((double) nullable1.GetValueOrDefault() != (double) nullable2.GetValueOrDefault() ? 1 : (nullable1.HasValue != nullable2.HasValue ? 1 : 0)) == 0)
          return;
        this.m_scale = value;
    ...
    {
      this.UpdateWorldVolume();
      BoundingBoxD.CreateMerged(ref MyPositionComponentBase.m_invalidBox, ref this.m_worldAABB, out this.m_worldAABBHr);
