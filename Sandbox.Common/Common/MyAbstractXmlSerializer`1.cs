...
namespace Sandbox.Common
{
  public class MyAbstractXmlSerializer<TAbstractBase> : IXmlSerializable
  {
    ...
    {
      string str = reader.GetAttribute("xsi:type") ?? MyObjectBuilderSerializer.GetSerializedName(typeof (TAbstractBase));
      ...
      this.Data = (TAbstractBase) MyObjectBuilderSerializer.GetSerializer(str).Deserialize((XmlReader) customRootReader);
