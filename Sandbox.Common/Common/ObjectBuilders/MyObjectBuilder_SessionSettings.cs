...
namespace Sandbox.Common.ObjectBuilders
{
    ...
    public class MyObjectBuilder_SessionSettings : MyObjectBuilder_Base
    {
        ...
        [ProtoMember(2)] public float InventorySizeMultiplier = 1f;
        [ProtoMember(3)] public float AssemblerSpeedMultiplier = 1f;
        [ProtoMember(4)] public float AssemblerEfficiencyMultiplier = 1f;
        [ProtoMember(5)] public float RefinerySpeedMultiplier = 1f;
        [ProtoMember(7)] public short MaxPlayers = (short) 4;
        [ProtoMember(8)] public short MaxFloatingObjects = (short) 256;
        [ProtoMember(10)] public bool AutoHealing = true;
        [ProtoMember(11)] public bool EnableCopyPaste = true;
        [ProtoMember(13)] public bool WeaponsEnabled = true;
        [ProtoMember(14)] public bool ShowPlayerNamesOnHud = true;
        [ProtoMember(15)] public bool ThrusterDamage = true;
        [ProtoMember(16)] public bool CargoShipsEnabled = true;
        [ProtoMember(20)] public bool RespawnShipDelete = true;
        [ProtoMember(22)] public float WelderSpeedMultiplier = 1f;
        [ProtoMember(23)] public float GrinderSpeedMultiplier = 1f;
        [ProtoMember(26)] public float HackSpeedMultiplier = 0.33f;
        [ProtoMember(27)] public bool? PermanentDeath = new bool?(true);
        [ProtoMember(28)] public uint AutoSaveInMinutes = 5U;
        [ProtoMember(29)] public float SpawnShipTimeMultiplier = 1f;
        [ProtoMember(32)] public bool DestructibleBlocks = true;
        [ProtoMember(33)] public bool EnableIngameScripts = true;
        [ProtoMember(34)] public int ViewDistance = 20000;
        [XmlIgnore] public const uint DEFAULT_AUTOSAVE_IN_MINUTES = 5U;
        [ProtoMember(6)] public MyOnlineModeEnum OnlineMode;
        [ProtoMember(9)] public MyEnvironmentHostilityEnum EnvironmentHostility;
        [ProtoMember(17)] public bool EnableSpectator;
        [ProtoMember(18)] public bool RemoveTrash;
        [ProtoMember(19)] public int WorldSizeKm;
        ...
        {
            get { return this.AutoSaveInMinutes > 0U; }
