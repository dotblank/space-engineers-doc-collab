...
namespace Sandbox.Common.ObjectBuilders.Definitions
{
    ...
    {
        [ProtoMember(1)] public float MinRadius;
        [ProtoMember(2)] public float MaxRadius;
        [ProtoMember(3)] public float BasePowerInput;
        [ProtoMember(4)] public float ConsumptionPower;
    }
}