...
namespace Sandbox.Common.ObjectBuilders
{
  ...
  public class MyObjectBuilder_Checkpoint : MyObjectBuilder_Base
  {
    ...
    public DateTime GameTime
    {
      get
      {
        return new DateTime(2081, 1, 1, 0, 0, 0, DateTimeKind.Utc) + new TimeSpan(this.ElapsedGameTime);
      }
      set
      {
        this.ElapsedGameTime = (value - new DateTime(2081, 1, 1)).Ticks;
      }
    }
    ...
    public MyOnlineModeEnum OnlineMode
    {
      get
      {
        return this.Settings.OnlineMode;
      }
      set
      {
    ...
    public MySessionHarvestMode HarvestMode
    {
      ...
      set
      {
        this.GameType = (MySessionGameType) value;
      }
    }
    ...
    public bool AutoHealing
    {
      get
      {
        return this.Settings.AutoHealing;
      }
      set
      {
    ...
    public bool AutoSave
    {
      get
      {
        return this.Settings.AutoSaveInMinutes > 0U;
      }
      set
      {
        this.Settings.AutoSaveInMinutes = value ? 5U : 0U;
      }
    }
    ...
    public bool EnableCopyPaste
    {
      get
      {
        return this.Settings.EnableCopyPaste;
      }
      set
      {
    ...
    public bool WeaponsEnabled
    {
      get
      {
        return this.Settings.WeaponsEnabled;
      }
      set
      {
    ...
    public bool ShowPlayerNamesOnHud
    {
      get
      {
        return this.Settings.ShowPlayerNamesOnHud;
      }
      set
      {
    ...
    public short MaxFloatingObjects
    {
      get
      {
        return this.Settings.MaxFloatingObjects;
      }
      set
      {
    ...
    public float InventorySizeMultiplier
    {
      get
      {
        return this.Settings.InventorySizeMultiplier;
      }
      set
      {
    ...
    public float AssemblerSpeedMultiplier
    {
      get
      {
        return this.Settings.AssemblerSpeedMultiplier;
      }
      set
      {
    ...
    public float AssemblerEfficiencyMultiplier
    {
      get
      {
        return this.Settings.AssemblerEfficiencyMultiplier;
      }
      set
      {
    ...
    public float RefinerySpeedMultiplier
    {
      get
      {
        return this.Settings.RefinerySpeedMultiplier;
      }
      set
      {
    ...
    public bool ThrusterDamage
    {
      get
      {
        return this.Settings.ThrusterDamage;
      }
      set
      {
    ...
    public bool CargoShipsEnabled
    {
      get
      {
        return this.Settings.CargoShipsEnabled;
      }
      set
      {
