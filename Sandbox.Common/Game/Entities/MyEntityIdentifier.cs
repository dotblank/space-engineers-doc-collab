...
namespace Sandbox.Game.Entities
{
  ...
  public struct MyEntityIdentifier
  {
    ...
    public static bool AllocationSuspended
    {
      get
      {
        return MyEntityIdentifier.m_allocationSuspended;
      }
      set
      {
        MyEntityIdentifier.m_allocationSuspended = value;
      }
    }
    ...
    public static long AllocateId(MyEntityIdentifier.ID_OBJECT_TYPE objectType = MyEntityIdentifier.ID_OBJECT_TYPE.ENTITY)
    {
    ...
    {
      if (identityType != MyEntityIdentifier.ID_OBJECT_TYPE.PLAYER && identityType != MyEntityIdentifier.ID_OBJECT_TYPE.NPC)
