...
namespace Sandbox.Definitions
{
  ...
  public class MyDefinitionBase
  {
    ...
    protected virtual void Init(MyObjectBuilder_DefinitionBase builder)
    {
      ...
      this.DisplayNameEnum = Enum.TryParse<MyTextsWrapperEnum>(builder.DisplayName, out result) ? new MyTextsWrapperEnum?(result) : new MyTextsWrapperEnum?();
      this.DescriptionEnum = builder.Description == null || !Enum.TryParse<MyTextsWrapperEnum>(builder.Description, out result) ? new MyTextsWrapperEnum?() : new MyTextsWrapperEnum?(result);
    ...
    public virtual MyObjectBuilder_DefinitionBase GetObjectBuilder()
    {
      ...
      objectBuilder.Description = this.DescriptionEnum.HasValue ? ((object) this.DescriptionEnum.Value).ToString() : ((object) this.DescriptionString).ToString();
      objectBuilder.DisplayName = this.DisplayNameEnum.HasValue ? ((object) this.DisplayNameEnum.Value).ToString() : ((object) this.DisplayNameString).ToString();
