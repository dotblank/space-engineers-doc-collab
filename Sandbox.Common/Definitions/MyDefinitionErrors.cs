...
namespace Sandbox.Definitions
{
    public static class MyDefinitionErrors
    {
        ...
        {
            MyLog.Default.WriteLine(string.Format("{0}: {1}", (object) e.ErrorSeverity,
                (object) (e.ModName ?? string.Empty)));
        ...
        public class Error
        {
            ...
            {
                get { return this.ModName != null ? "mod_" : "definition_"; }
            }
            ...
            {
                return string.Format("{0}: {1}, in file: {2}\n{3}", (object) this.ErrorSeverity,
                    (object) (this.ModName ?? string.Empty), (object) this.ErrorFile, (object) this.Message);
            }
            ...
            public static Color GetSeverityColor(ErrorSeverity severity)
            {
                ...
                catch (Exception ex)
                {
                    MyLog.Default.WriteLine(
                        string.Format("Error type does not have color assigned: message: {0}, stack:{1}",
            ...
            public static string GetSeverityName(ErrorSeverity severity, bool plural)
            {
                ...
                {
                    MyLog.Default.WriteLine(
                        string.Format("Error type does not have name assigned: message: {0}, stack:{1}",
                            (object) ex.Message, (object) ex.StackTrace));
