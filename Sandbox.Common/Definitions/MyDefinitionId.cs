...
namespace Sandbox.Definitions
{
  public struct MyDefinitionId : IEquatable<MyDefinitionId>
  {
    ...
    public string SubtypeName
    {
      get
      {
        return this.SubtypeId.ToString();
      }
    }
    ...
    {
      return string.Format("{0}/{1}", !this.TypeId.IsNull ? (object) this.TypeId.ToString() : (object) "(null)", !string.IsNullOrEmpty(this.SubtypeName) ? (object) this.SubtypeName : (object) "(null)");
    }
