...
namespace KeenSoftwareHouse.Library.IO
{
  public class Win32Processes
  {
    ...
    private static List<string> UnsafeGetFilesLockedBy(Process process)
    {
      try
      {
        IEnumerable<Win32Processes.Win32API.SYSTEM_HANDLE_INFORMATION> handles = Win32Processes.GetHandles(process);
    ...
    private static string GetFilePath(Win32Processes.Win32API.SYSTEM_HANDLE_INFORMATION systemHandleInformation, Process process)
    {
      IntPtr hSourceProcessHandle = Win32Processes.Win32API.OpenProcess(Win32Processes.Win32API.ProcessAccessFlags.All, false, process.Id);
      Win32Processes.Win32API.OBJECT_BASIC_INFORMATION basicInformation1 = new Win32Processes.Win32API.OBJECT_BASIC_INFORMATION();
      Win32Processes.Win32API.OBJECT_TYPE_INFORMATION objectTypeInformation1 = new Win32Processes.Win32API.OBJECT_TYPE_INFORMATION();
      Win32Processes.Win32API.OBJECT_NAME_INFORMATION objectNameInformation1 = new Win32Processes.Win32API.OBJECT_NAME_INFORMATION();
      string strRawName = "";
      int returnLength = 0;
      IntPtr lpTargetHandle;
      if (!Win32Processes.Win32API.DuplicateHandle(hSourceProcessHandle, systemHandleInformation.Handle, Win32Processes.Win32API.GetCurrentProcess(), out lpTargetHandle, 0U, false, 2U))
        return (string) null;
      IntPtr num1 = Marshal.AllocHGlobal(Marshal.SizeOf((object) basicInformation1));
      Win32Processes.Win32API.NtQueryObject(lpTargetHandle, 0, num1, Marshal.SizeOf((object) basicInformation1), ref returnLength);
      Win32Processes.Win32API.OBJECT_BASIC_INFORMATION basicInformation2 = (Win32Processes.Win32API.OBJECT_BASIC_INFORMATION) Marshal.PtrToStructure(num1, basicInformation1.GetType());
      Marshal.FreeHGlobal(num1);
      IntPtr num2 = Marshal.AllocHGlobal(basicInformation2.TypeInformationLength);
      for (returnLength = basicInformation2.TypeInformationLength; Win32Processes.Win32API.NtQueryObject(lpTargetHandle, 2, num2, returnLength, ref returnLength) == -1073741820; num2 = Marshal.AllocHGlobal(returnLength))
      {
        if (returnLength == 0)
        {
      ...
      Win32Processes.Win32API.OBJECT_TYPE_INFORMATION objectTypeInformation2 = (Win32Processes.Win32API.OBJECT_TYPE_INFORMATION) Marshal.PtrToStructure(num2, objectTypeInformation1.GetType());
      IntPtr num3 = !Win32Processes.Is64Bits() ? objectTypeInformation2.Name.Buffer : new IntPtr(Convert.ToInt64(objectTypeInformation2.Name.Buffer.ToString(), 10) >> 32);
      ...
      IntPtr num4;
      for (num4 = Marshal.AllocHGlobal(returnLength); Win32Processes.Win32API.NtQueryObject(lpTargetHandle, 1, num4, returnLength, ref returnLength) == -1073741820; num4 = Marshal.AllocHGlobal(returnLength))
      {
      ...
      Win32Processes.Win32API.OBJECT_NAME_INFORMATION objectNameInformation2 = (Win32Processes.Win32API.OBJECT_NAME_INFORMATION) Marshal.PtrToStructure(num4, objectNameInformation1.GetType());
      num3 = !Win32Processes.Is64Bits() ? objectNameInformation2.Name.Buffer : new IntPtr(Convert.ToInt64(objectNameInformation2.Name.Buffer.ToString(), 10) >> 32);
      if (num3 != IntPtr.Zero)
      {
        ...
        try
        {
          ...
          strRawName = Marshal.PtrToStringUni(Win32Processes.Is64Bits() ? new IntPtr(num3.ToInt64()) : new IntPtr(num3.ToInt32()));
        }
    ...
    private static IEnumerable<Win32Processes.Win32API.SYSTEM_HANDLE_INFORMATION> GetHandles(Process process)
    {
      ...
      int returnLength;
      for (returnLength = 0; (int) Win32Processes.Win32API.NtQuerySystemInformation(16, num2, num1, ref returnLength) == -1073741820; num2 = Marshal.AllocHGlobal(returnLength))
      {
        num1 = returnLength;
        Marshal.FreeHGlobal(num2);
      }
      ...
      List<Win32Processes.Win32API.SYSTEM_HANDLE_INFORMATION> list = new List<Win32Processes.Win32API.SYSTEM_HANDLE_INFORMATION>();
      for (long index = 0L; index < num3; ++index)
      {
        Win32Processes.Win32API.SYSTEM_HANDLE_INFORMATION handleInformation1 = new Win32Processes.Win32API.SYSTEM_HANDLE_INFORMATION();
        Win32Processes.Win32API.SYSTEM_HANDLE_INFORMATION handleInformation2;
        if (Win32Processes.Is64Bits())
        {
          handleInformation2 = (Win32Processes.Win32API.SYSTEM_HANDLE_INFORMATION) Marshal.PtrToStructure(ptr, handleInformation1.GetType());
    ...
    internal class Win32API
    {
      ...
      public static extern IntPtr OpenProcess(Win32Processes.Win32API.ProcessAccessFlags dwDesiredAccess, [MarshalAs(UnmanagedType.Bool)] bool bInheritHandle, int dwProcessId);
