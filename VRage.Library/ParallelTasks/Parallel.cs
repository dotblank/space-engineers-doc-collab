...
namespace ParallelTasks
{
    public static class Parallel
    {
        ...
        [ThreadStatic] private static MyConcurrentQueue<WorkItem> m_callbackBuffer;
        ...
        {
            get { return Parallel._processorAffinity; }
            set
            {
                if (value == null)
                    throw new ArgumentNullException("value");
                if (value.Length < 1)
                    throw new ArgumentException("The Parallel.ProcessorAffinity must contain at least one value.",
                        "value");
        ...
        public static IWorkScheduler Scheduler
        {
            get
            {
                if (Parallel.scheduler == null)
                {
                    ...
                    Interlocked.CompareExchange<IWorkScheduler>(ref Parallel.scheduler, workScheduler,
                        (IWorkScheduler) null);
                }
