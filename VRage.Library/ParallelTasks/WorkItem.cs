...
namespace ParallelTasks
{
  internal class WorkItem
  {
    ...
    private static Hashtable<Thread, Stack<Task>> runningTasks = new Hashtable<Thread, Stack<Task>>(Environment.ProcessorCount);
    ...
    public bool DoWork(int expectedID)
    {
      ...
      catch (Exception ex)
      {
        if (this.exceptionBuffer == null)
          Interlocked.CompareExchange<List<Exception>>(ref this.exceptionBuffer, new List<Exception>(), (List<Exception>) null);
