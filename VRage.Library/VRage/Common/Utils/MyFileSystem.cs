...
namespace VRage.Common.Utils
{
  public static class MyFileSystem
  {
    ...
    public static IEnumerable<string> GetFiles(string path, string filter = "*", VRage.FileSystem.SearchOption searchOption = VRage.FileSystem.SearchOption.AllDirectories)
    {
