...
// Type: VRage.Service.MyServiceBase
...
namespace VRage.Service
{
    ...
    public class MyServiceBase : Component
    {
        ...
        public int ExitCode
        {
            get { return this.status.win32ExitCode; }
            set { this.status.win32ExitCode = value; }
        }

        [DefaultValue(false)]
        public bool CanHandlePowerEvent
        {
            get { return (this.acceptedCommands & 64) != 0; }
            set
            {
                if (this.commandPropsFrozen)
                    throw new InvalidOperationException(MyServiceBase.GetString("CannotChangeProperties"));
                if (value)
        ...
        {
            get { return (this.acceptedCommands & 128) != 0; }
            set
            {
                if (this.commandPropsFrozen)
                    throw new InvalidOperationException(MyServiceBase.GetString("CannotChangeProperties"));
        ...
        {
            get { return (this.acceptedCommands & 2) != 0; }
            set
            {
                if (this.commandPropsFrozen)
                    throw new InvalidOperationException(MyServiceBase.GetString("CannotChangeProperties"));
        ...
        {
            get { return (this.acceptedCommands & 4) != 0; }
            set
            {
                if (this.commandPropsFrozen)
                    throw new InvalidOperationException(MyServiceBase.GetString("CannotChangeProperties"));
        ...
        public bool CanStop
        {
            get { return (this.acceptedCommands & 1) != 0; }
            set
            {
                if (this.commandPropsFrozen)
                    throw new InvalidOperationException(MyServiceBase.GetString("CannotChangeProperties"));
        ...
        public string ServiceName
        {
            ...
            {
                if (this.nameFrozen)
                    throw new InvalidOperationException(MyServiceBase.GetString("CannotChangeName"));
                if (value != "" && !MyServiceBase.ValidServiceName(value))
                    throw new ArgumentException(MyServiceBase.GetString("ServiceName", (object) value,
                        (object) 80.ToString((IFormatProvider) CultureInfo.CurrentCulture)));
                else
        ...
        public unsafe void RequestAdditionalTime(int milliseconds)
        {
            ...
            {
                if (this.status.currentState != 5 && this.status.currentState != 2 &&
                    (this.status.currentState != 3 && this.status.currentState != 6))
                    throw new InvalidOperationException(MyServiceBase.GetString("NotInPendingState"));
        ...
        private unsafe void DeferredStop()
        {
            fixed (NativeMethods.SERVICE_STATUS* status = &this.status)
            {
                ...
                {
                    this.OnStop();
                    this.WriteEventLogEntry(MyServiceBase.GetString("StopSuccessful"));
                    ...
                    if (this.isServiceHosted)
                    {
                        ...
                        catch (CannotUnloadAppDomainException ex)
                        {
                            this.WriteEventLogEntry(
                                MyServiceBase.GetString("FailedToUnloadAppDomain",
                                    (object) AppDomain.CurrentDomain.FriendlyName, (object) ex.Message),
                ...
                catch (Exception ex)
                {
                    ...
                    NativeMethods.SetServiceStatus(this.statusHandle, status);
                    this.WriteEventLogEntry(MyServiceBase.GetString("StopFailed", (object) ((object) ex).ToString()),
                        EventLogEntryType.Error);
                    throw;
                }
            }
        ...
        public static void Run(MyServiceBase[] services)
        {
            if (services == null || services.Length == 0)
                throw new ArgumentException(MyServiceBase.GetString("NoServices"));
            if (Environment.OSVersion.Platform != PlatformID.Win32NT)
            {
                MyServiceBase.LateBoundMessageBoxShow(MyServiceBase.GetString("CantRunOnWin9x"),
                    MyServiceBase.GetString("CantRunOnWin9xTitle"));
            }
            else
            {
                IntPtr entry =
                    Marshal.AllocHGlobal(
                        (IntPtr) ((services.Length + 1)*Marshal.SizeOf(typeof (NativeMethods.SERVICE_TABLE_ENTRY))));
                NativeMethods.SERVICE_TABLE_ENTRY[] serviceTableEntryArray =
                    new NativeMethods.SERVICE_TABLE_ENTRY[services.Length];
                ...
                for (int index = 0; index < services.Length; ++index)
                {
                    ...
                    IntPtr ptr =
                        (IntPtr)
                            ((long) entry + (long) (Marshal.SizeOf(typeof (NativeMethods.SERVICE_TABLE_ENTRY))*index));
                ...
                IntPtr ptr1 =
                    (IntPtr)
                        ((long) entry +
                         (long) (Marshal.SizeOf(typeof (NativeMethods.SERVICE_TABLE_ENTRY))*services.Length));
                ...
                if (!flag)
                {
                    ...
                    string string1 = MyServiceBase.GetString("CantStartFromCommandLine");
                    if (Environment.UserInteractive)
                    {
                        string string2 = MyServiceBase.GetString("CantStartFromCommandLineTitle");
                        MyServiceBase.LateBoundMessageBoxShow(string1, string2);
                    }
                    else
                        Console.WriteLine(string1);
                }
                foreach (MyServiceBase myServiceBase in services)
                {
                    myServiceBase.Dispose();
                    if (!flag && myServiceBase.EventLog.Source.Length != 0)
                        myServiceBase.WriteEventLogEntry(MyServiceBase.GetString("StartFailed", (object) str),
                            EventLogEntryType.Error);
                }
            }
        }
        ...
        public unsafe void ServiceMainCallback(int argCount, IntPtr argPointer)
        {
            fixed (NativeMethods.SERVICE_STATUS* status = &this.status)
            {
                ...
                if (argCount > 0)
                {
                    ...
                    this.UsedServiceName = Marshal.PtrToStringUni((IntPtr) ((void*) *chPtr));
                ...
                this.statusHandle = Environment.OSVersion.Version.Major < 5
                    ? NativeMethods.RegisterServiceCtrlHandler(this.ServiceName, (Delegate) this.commandCallback)
                    : NativeMethods.RegisterServiceCtrlHandlerEx(this.ServiceName, (Delegate) this.commandCallbackEx,
                        (IntPtr) 0);
                this.nameFrozen = true;
                if (this.statusHandle == (IntPtr) 0)
                    this.WriteEventLogEntry(
                        MyServiceBase.GetString("StartFailed", (object) new Win32Exception().Message),
                        EventLogEntryType.Error);
        ...
        private unsafe void DeferredContinue()
        {
            fixed (NativeMethods.SERVICE_STATUS* status = &this.status)
            {
                ...
                {
                    this.OnContinue();
                    this.WriteEventLogEntry(MyServiceBase.GetString("ContinueSuccessful"));
                ...
                catch (Exception ex)
                {
                    ...
                    this.WriteEventLogEntry(
                        MyServiceBase.GetString("ContinueFailed", (object) ((object) ex).ToString()),
                        EventLogEntryType.Error);
                    throw;
                }
                finally
        ...
        private void DeferredCustomCommand(int command)
        {
            try
            {
                ...
                this.WriteEventLogEntry(MyServiceBase.GetString("CommandSuccessful"));
            }
            catch (Exception ex)
            {
                this.WriteEventLogEntry(MyServiceBase.GetString("CommandFailed", (object) ((object) ex).ToString()),
                    EventLogEntryType.Error);
                throw;
            }
        }
        ...
        private unsafe void DeferredPause()
        {
            fixed (NativeMethods.SERVICE_STATUS* status = &this.status)
            {
                ...
                {
                    this.OnPause();
                    this.WriteEventLogEntry(MyServiceBase.GetString("PauseSuccessful"));
                    this.status.currentState = 7;
                }
                catch (Exception ex)
                {
                    this.status.currentState = 4;
                    this.WriteEventLogEntry(MyServiceBase.GetString("PauseFailed", (object) ((object) ex).ToString()),
                        EventLogEntryType.Error);
                    throw;
                }
                finally
        ...
        private void DeferredPowerEvent(int eventType, IntPtr eventData)
        {
            try
            {
                ...
                this.WriteEventLogEntry(MyServiceBase.GetString("PowerEventOK"));
            }
            catch (Exception ex)
            {
                this.WriteEventLogEntry(MyServiceBase.GetString("PowerEventFailed", (object) ((object) ex).ToString()),
                    EventLogEntryType.Error);
                throw;
            }
        }
        ...
        private void DeferredSessionChange(int eventType, int sessionId)
        {
            try
            {
                this.OnSessionChange(NativeMethods.CreateSessionChangeDescription((SessionChangeReason) eventType,
                    sessionId));
            }
            catch (Exception ex)
            {
                this.WriteEventLogEntry(
                    MyServiceBase.GetString("SessionChangeFailed", (object) ((object) ex).ToString()),
                    EventLogEntryType.Error);
                throw;
            }
        }
        ...
        private unsafe void DeferredShutdown()
        {
            ...
            {
                this.OnShutdown();
                this.WriteEventLogEntry(MyServiceBase.GetString("ShutdownOK"));
            ...
            {
                this.WriteEventLogEntry(MyServiceBase.GetString("ShutdownFailed", (object) ((object) ex).ToString()),
                    EventLogEntryType.Error);
                throw;
            }
        }
        ...
        private static void LateBoundMessageBoxShow(string message, string title)
        {
            ...
            Type type2 =
                Type.GetType(
                    "System.Windows.Forms.MessageBoxButtons, System.Windows.Forms, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089");
            Type type3 =
                Type.GetType(
                    "System.Windows.Forms.MessageBoxIcon, System.Windows.Forms, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089");
            Type type4 =
                Type.GetType(
                    "System.Windows.Forms.MessageBoxDefaultButton, System.Windows.Forms, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089");
            Type type5 =
                Type.GetType(
                    "System.Windows.Forms.MessageBoxOptions, System.Windows.Forms, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089");
            type1.InvokeMember("Show", BindingFlags.Static | BindingFlags.Public | BindingFlags.InvokeMethod,
                (Binder) null, (object) null, new object[6]
                {
                    (object) message,
                    (object) title,
        ...
        private int ServiceCommandCallbackEx(int command, int eventType, IntPtr eventData, IntPtr eventContext)
        {
            ...
            {
                case 13:
                    new MyServiceBase.DeferredHandlerDelegateAdvanced(this.DeferredPowerEvent).BeginInvoke(eventType,
                        eventData, (AsyncCallback) null, (object) null);
                    break;
                case 14:
                    MyServiceBase.DeferredHandlerDelegateAdvancedSession delegateAdvancedSession =
                        new MyServiceBase.DeferredHandlerDelegateAdvancedSession(this.DeferredSessionChange);
                    NativeMethods.WTSSESSION_NOTIFICATION wtssessionNotification =
                        new NativeMethods.WTSSESSION_NOTIFICATION();
                    Marshal.PtrToStructure(eventData, (object) wtssessionNotification);
                    delegateAdvancedSession.BeginInvoke(eventType, wtssessionNotification.sessionId,
        ...
        private unsafe void ServiceCommandCallback(int command)
        {
            fixed (NativeMethods.SERVICE_STATUS* status = &this.status)
            {
                if (command == 4)
                    NativeMethods.SetServiceStatus(this.statusHandle, status);
                else if (this.status.currentState != 5 && this.status.currentState != 2 &&
                         (this.status.currentState != 3 && this.status.currentState != 6))
                {
                    switch (command)
                    {
                        case 1:
                            ...
                            if (this.status.currentState == 7 || this.status.currentState == 4)
                            {
                                ...
                                NativeMethods.SetServiceStatus(this.statusHandle, status);
                                this.status.currentState = num;
                                new MyServiceBase.DeferredHandlerDelegate(this.DeferredStop).BeginInvoke(
                                    (AsyncCallback) null, (object) null);
                                break;
                            }
                            else
                        ...
                        case 2:
                            if (this.status.currentState == 4)
                            {
                                ...
                                NativeMethods.SetServiceStatus(this.statusHandle, status);
                                new MyServiceBase.DeferredHandlerDelegate(this.DeferredPause).BeginInvoke(
                                    (AsyncCallback) null, (object) null);
                                break;
                            }
                            else
                        ...
                        case 3:
                            if (this.status.currentState == 7)
                            {
                                ...
                                NativeMethods.SetServiceStatus(this.statusHandle, status);
                                new MyServiceBase.DeferredHandlerDelegate(this.DeferredContinue).BeginInvoke(
                                    (AsyncCallback) null, (object) null);
                                break;
                            }
                            else
                                break;
                        case 5:
                            new MyServiceBase.DeferredHandlerDelegate(this.DeferredShutdown).BeginInvoke(
                                (AsyncCallback) null, (object) null);
                            break;
                        default:
                            new MyServiceBase.DeferredHandlerDelegateCommand(this.DeferredCustomCommand).BeginInvoke
                                (command, (AsyncCallback) null, (object) null);
                            break;
                    }
                }
            }
        ...
        private void ServiceQueuedMainCallback(object state)
        {
            ...
            {
                this.OnStart(args);
                this.WriteEventLogEntry(MyServiceBase.GetString("StartSuccessful"));
                this.status.checkPoint = 0;
                this.status.waitHint = 0;
                this.status.currentState = 4;
            }
            ...
            {
                this.WriteEventLogEntry(MyServiceBase.GetString("StartFailed", (object) ((object) ex).ToString()),
                    EventLogEntryType.Error);
                this.status.currentState = 1;
            }
