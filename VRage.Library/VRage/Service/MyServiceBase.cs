...
namespace VRage.Service
{
  ...
  public class MyServiceBase : Component
  {
    ...
    public string ServiceName
    {
      ...
      set
      {
        ...
        if (value != "" && !MyServiceBase.ValidServiceName(value))
          throw new ArgumentException(MyServiceBase.GetString("ServiceName", (object) value, (object) 80.ToString((IFormatProvider) CultureInfo.CurrentCulture)));
        else
      ...
      fixed (NativeMethods.SERVICE_STATUS* status = &this.status)
      {
        ...
        try
        {
          ...
          if (this.isServiceHosted)
          {
            ...
            {
              this.WriteEventLogEntry(MyServiceBase.GetString("FailedToUnloadAppDomain", (object) AppDomain.CurrentDomain.FriendlyName, (object) ex.Message), EventLogEntryType.Error);
            }
          }
        }
        catch (Exception ex)
        {
          ...
          NativeMethods.SetServiceStatus(this.statusHandle, status);
          this.WriteEventLogEntry(MyServiceBase.GetString("StopFailed", (object) ((object) ex).ToString()), EventLogEntryType.Error);
          throw;
        }
      }
    }
    ...
    public static void Run(MyServiceBase[] services)
    {
      ...
      {
        MyServiceBase.LateBoundMessageBoxShow(MyServiceBase.GetString("CantRunOnWin9x"), MyServiceBase.GetString("CantRunOnWin9xTitle"));
      }
      else
      {
        ...
        foreach (MyServiceBase myServiceBase in services)
        {
          ...
          if (!flag && myServiceBase.EventLog.Source.Length != 0)
            myServiceBase.WriteEventLogEntry(MyServiceBase.GetString("StartFailed", (object) str), EventLogEntryType.Error);
        }
      }
    }
    ...
    public unsafe void ServiceMainCallback(int argCount, IntPtr argPointer)
    {
      fixed (NativeMethods.SERVICE_STATUS* status = &this.status)
      {
        ...
        if (this.statusHandle == (IntPtr) 0)
          this.WriteEventLogEntry(MyServiceBase.GetString("StartFailed", (object) new Win32Exception().Message), EventLogEntryType.Error);
    ...
    private unsafe void DeferredContinue()
    {
      fixed (NativeMethods.SERVICE_STATUS* status = &this.status)
      {
        ...
        catch (Exception ex)
        {
          ...
          this.WriteEventLogEntry(MyServiceBase.GetString("ContinueFailed", (object) ((object) ex).ToString()), EventLogEntryType.Error);
          throw;
        }
        finally
        {
    ...
    private void DeferredCustomCommand(int command)
    {
      ...
      {
        this.WriteEventLogEntry(MyServiceBase.GetString("CommandFailed", (object) ((object) ex).ToString()), EventLogEntryType.Error);
        throw;
      }
    }
    ...
    private unsafe void DeferredPause()
    {
      fixed (NativeMethods.SERVICE_STATUS* status = &this.status)
      {
        ...
        {
          this.status.currentState = 4;
          this.WriteEventLogEntry(MyServiceBase.GetString("PauseFailed", (object) ((object) ex).ToString()), EventLogEntryType.Error);
          throw;
        }
        finally
        {
    ...
    private void DeferredPowerEvent(int eventType, IntPtr eventData)
    {
      ...
      {
        this.WriteEventLogEntry(MyServiceBase.GetString("PowerEventFailed", (object) ((object) ex).ToString()), EventLogEntryType.Error);
        throw;
      }
    }
    ...
    private void DeferredSessionChange(int eventType, int sessionId)
    {
      ...
      {
        this.WriteEventLogEntry(MyServiceBase.GetString("SessionChangeFailed", (object) ((object) ex).ToString()), EventLogEntryType.Error);
        throw;
      }
    }
    ...
    private unsafe void DeferredShutdown()
    {
      ...
      {
        this.WriteEventLogEntry(MyServiceBase.GetString("ShutdownFailed", (object) ((object) ex).ToString()), EventLogEntryType.Error);
        throw;
      }
    }
    ...
    private void ServiceQueuedMainCallback(object state)
    {
      ...
      {
        this.WriteEventLogEntry(MyServiceBase.GetString("StartFailed", (object) ((object) ex).ToString()), EventLogEntryType.Error);
        this.status.currentState = 1;
      }
