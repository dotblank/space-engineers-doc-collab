...
namespace VRage.Serialization
{
    public class TupleSerializer<T1, T2, T3, T4, T5> : ISerializer<MyTuple<T1, T2, T3, T4, T5>>
    {
        ...
        public TupleSerializer(ISerializer<T1> serializer1, ISerializer<T2> serializer2, ISerializer<T3> serializer3,
            ISerializer<T4> serializer4, ISerializer<T5> serializer5)
        {
        ...
        void ISerializer<MyTuple<T1, T2, T3, T4, T5>>.Serialize(ByteStream destination,
        ...
        void ISerializer<MyTuple<T1, T2, T3, T4, T5>>.Deserialize(ByteStream source,
