...
namespace VRage.Serialization
{
    public class TupleSerializer<T1, T2, T3, T4, T5, T6> : ISerializer<MyTuple<T1, T2, T3, T4, T5, T6>>
    {
        ...
        public TupleSerializer(ISerializer<T1> serializer1, ISerializer<T2> serializer2, ISerializer<T3> serializer3,
            ISerializer<T4> serializer4, ISerializer<T5> serializer5, ISerializer<T6> serializer6)
        {
        ...
        void ISerializer<MyTuple<T1, T2, T3, T4, T5, T6>>.Serialize(ByteStream destination,
        ...
        void ISerializer<MyTuple<T1, T2, T3, T4, T5, T6>>.Deserialize(ByteStream source,
