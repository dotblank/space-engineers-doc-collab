...
namespace VRage
{
    public struct MyTimeSpan
    {
        ...
        {
            get { return (double) this.Ticks/((double) MyGameTimer.Frequency/1000000000.0); }
        }

        public double Microseconds
        {
            get { return (double) this.Ticks/((double) MyGameTimer.Frequency/1000000.0); }
        }

        public double Miliseconds
        {
            get { return (double) this.Ticks/((double) MyGameTimer.Frequency/1000.0); }
        }

        public double Seconds
        {
            get { return (double) this.Ticks/(double) MyGameTimer.Frequency; }
        }
        ...
        public TimeSpan TimeSpan
        {
            get
            {
                return
                    TimeSpan.FromTicks(
                        (long) Math.Round((double) this.Ticks*(10000000.0/(double) MyGameTimer.Frequency)));
            }
        }

        public MyTimeSpan(long ticks)
        {
            this.Ticks = ticks;
        }
