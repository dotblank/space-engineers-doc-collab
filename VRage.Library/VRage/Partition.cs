...
namespace VRage
{
    ...
    {
        private static readonly string[] m_letters =
            Enumerable.ToArray<string>(Enumerable.Select<int, string>(Enumerable.Range(65, 26),
                (Func<int, string>) (s => new string((char) s, 1))));
