...
namespace VRage.Collections
{
    public class MySinglyLinkedList<V> : IList<V>, ICollection<V>, IEnumerable<V>, IEnumerable
    {
        ...
        public MySinglyLinkedList<V> Split(MySinglyLinkedList<V>.Enumerator newLastPosition, int newCount = -1)
        {
            ...
            {
                newCount = 1;
                for (MySinglyLinkedList<V>.Node node = this.m_rootNode;
                    node != newLastPosition.m_currentNode;
                    node = node.Next)
                    ++newCount;
            }
            ...
            singlyLinkedList.m_lastNode = singlyLinkedList.m_rootNode == null
                ? (MySinglyLinkedList<V>.Node) null
                : this.m_lastNode;
        ...
        public struct Enumerator : IEnumerator<V>, IDisposable, IEnumerator
        {
            ...
            public V Current
            {
                get { return this.m_currentNode.Data; }
            }

            public bool HasCurrent
            {
                get { return this.m_currentNode != null; }
            }

            object IEnumerator.Current
            {
                get { return (object) this.m_currentNode.Data; }
            }
