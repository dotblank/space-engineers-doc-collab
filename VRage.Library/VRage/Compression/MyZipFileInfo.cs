...
namespace VRage.Compression
{
  public struct MyZipFileInfo
  {
    ...
    public CompressionMethodEnum CompressionMethod
    {
      get
      {
        return (CompressionMethodEnum) MyZipFileInfoReflection.CompressionMethod(this.m_fileInfo);
      }
    }
    ...
    public DeflateOptionEnum DeflateOption
    {
      get
      {
        return (DeflateOptionEnum) MyZipFileInfoReflection.DeflateOption(this.m_fileInfo);
      }
    }
    ...
    public bool FolderFlag
    {
      get
      {
        return MyZipFileInfoReflection.FolderFlag(this.m_fileInfo);
      }
    }
    ...
    public DateTime LastModFileDateTime
    {
      get
      {
        return MyZipFileInfoReflection.LastModFileDateTime(this.m_fileInfo);
      }
    }
    ...
    public string Name
    {
      get
      {
        return MyZipFileInfoReflection.Name(this.m_fileInfo);
      }
    }
    ...
    public bool VolumeLabelFlag
    {
      get
      {
        return MyZipFileInfoReflection.VolumeLabelFlag(this.m_fileInfo);
      }
    }
