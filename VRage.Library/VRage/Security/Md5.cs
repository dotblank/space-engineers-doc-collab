...
namespace VRage.Security
{
  public static class Md5
  {
    ...
    public class Hash
    {
      ...
      {
        return Md5.Hash.ReverseByte(this.A).ToString("X8") + Md5.Hash.ReverseByte(this.B).ToString("X8") + Md5.Hash.ReverseByte(this.C).ToString("X8") + Md5.Hash.ReverseByte(this.D).ToString("X8");
      }
