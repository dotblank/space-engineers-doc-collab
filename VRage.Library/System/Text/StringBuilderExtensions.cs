  ...
  public static class StringBuilderExtensions
  {
    ...
    static StringBuilderExtensions()
    {
      if (StringBuilderExtensions.m_numberFormatInfoHelper != null)
        return;
      StringBuilderExtensions.m_numberFormatInfoHelper = CultureInfo.InvariantCulture.NumberFormat.Clone() as NumberFormatInfo;
    }
    ...
    {
      return StringBuilderExtensions.ConcatFormat<A, int, int, int>(string_builder, format_string, arg1, 0, 0, 0, numberFormat);
    }
    ...
    {
      return StringBuilderExtensions.ConcatFormat<A, B, int, int>(string_builder, format_string, arg1, arg2, 0, 0, numberFormat);
    }
    ...
    {
      return StringBuilderExtensions.ConcatFormat<A, B, C, int>(string_builder, format_string, arg1, arg2, arg3, 0, numberFormat);
    }
      ...
      for (int index1 = 0; index1 < format_string.Length; ++index1)
      {
        if ((int) format_string[index1] == 123)
        {
          ...
          else
          {
            ...
            {
              case '0':
                StringBuilderExtensions.ConcatFormatValue<A>(string_builder, arg1, padding, base_value, decimal_places, thousandSeparation);
                break;
              case '1':
                StringBuilderExtensions.ConcatFormatValue<B>(string_builder, arg2, padding, base_value, decimal_places, thousandSeparation);
                break;
              case '2':
                StringBuilderExtensions.ConcatFormatValue<C>(string_builder, arg3, padding, base_value, decimal_places, thousandSeparation);
                break;
              case '3':
                StringBuilderExtensions.ConcatFormatValue<D>(string_builder, arg4, padding, base_value, decimal_places, thousandSeparation);
                break;
            }
          }
          startIndex = index1 + 1;
    ...
    private static void ConcatFormatValue<T>(this StringBuilder string_builder, T arg, uint padding, uint base_value, uint decimal_places, bool thousandSeparation) where T : IConvertible
    {
      switch (arg.GetTypeCode())
      {
        ...
        case TypeCode.Int32:
          StringBuilderExtensions.Concat(string_builder, arg.ToInt32((IFormatProvider) NumberFormatInfo.InvariantInfo), padding, '0', base_value, thousandSeparation);
          break;
        case TypeCode.UInt32:
          StringBuilderExtensions.Concat(string_builder, (long) arg.ToUInt32((IFormatProvider) NumberFormatInfo.InvariantInfo), padding, '0', base_value, thousandSeparation);
          break;
        case TypeCode.Int64:
          StringBuilderExtensions.Concat(string_builder, arg.ToInt64((IFormatProvider) NumberFormatInfo.InvariantInfo), padding, '0', base_value, thousandSeparation);
          break;
        case TypeCode.UInt64:
          StringBuilderExtensions.Concat(string_builder, arg.ToInt32((IFormatProvider) NumberFormatInfo.InvariantInfo), padding, '0', base_value, thousandSeparation);
          break;
        case TypeCode.Single:
          StringBuilderExtensions.Concat(string_builder, arg.ToSingle((IFormatProvider) NumberFormatInfo.InvariantInfo), decimal_places, padding, '0', false);
          break;
        case TypeCode.Double:
          StringBuilderExtensions.Concat(string_builder, arg.ToDouble((IFormatProvider) NumberFormatInfo.InvariantInfo), decimal_places, padding, '0', false);
          break;
    ...
    {
      StringBuilderExtensions.Concat(string_builder, (long) uint_val, 0U, StringBuilderExtensions.ms_default_pad_char, 10U, true);
      return string_builder;
    }

    public static StringBuilder Concat(this StringBuilder string_builder, uint uint_val, uint pad_amount)
    {
      StringBuilderExtensions.Concat(string_builder, (long) uint_val, pad_amount, StringBuilderExtensions.ms_default_pad_char, 10U, true);
      return string_builder;
    }
    ...
    public static StringBuilder Concat(this StringBuilder string_builder, int int_val, uint pad_amount, char pad_char, uint base_val, bool thousandSeparation)
    {
      if (int_val < 0)
      {
        ...
        StringBuilderExtensions.Concat(string_builder, (long) num, pad_amount, pad_char, base_val, thousandSeparation);
      }
      else
        StringBuilderExtensions.Concat(string_builder, (long) (uint) int_val, pad_amount, pad_char, base_val, thousandSeparation);
      return string_builder;
    }
    ...
    public static StringBuilder Concat(this StringBuilder string_builder, long long_val, uint pad_amount, char pad_char, uint base_val, bool thousandSeparation)
    {
      if (long_val < 0L)
      {
        ...
        StringBuilderExtensions.Concat(string_builder, uint_val, pad_amount, pad_char, base_val, thousandSeparation);
      }
      else
        StringBuilderExtensions.Concat(string_builder, (ulong) long_val, pad_amount, pad_char, base_val, thousandSeparation);
      return string_builder;
    }

    public static StringBuilder Concat(this StringBuilder string_builder, int int_val)
    {
      StringBuilderExtensions.Concat(string_builder, int_val, 0U, StringBuilderExtensions.ms_default_pad_char, 10U, true);
      return string_builder;
    }

    public static StringBuilder Concat(this StringBuilder string_builder, int int_val, uint pad_amount)
    {
      StringBuilderExtensions.Concat(string_builder, int_val, pad_amount, StringBuilderExtensions.ms_default_pad_char, 10U, true);
      return string_builder;
    }
    ...
    public static StringBuilder Concat(this StringBuilder string_builder, float float_val, uint decimal_places, uint pad_amount, char pad_char, bool thousandSeparator)
    {
      ...
      else
      {
        ...
        while (num3 > 0U);
        StringBuilderExtensions.Concat(string_builder, (long) (uint) num2, decimal_places, '0', 10U, thousandSeparator);
      }
      return string_builder;
    }
    ...
    {
      StringBuilderExtensions.Concat(string_builder, float_val, StringBuilderExtensions.ms_default_decimal_places, 0U, StringBuilderExtensions.ms_default_pad_char, false);
      return string_builder;
    }

    public static StringBuilder Concat(this StringBuilder string_builder, float float_val, uint decimal_places)
    {
      StringBuilderExtensions.Concat(string_builder, float_val, decimal_places, 0U, StringBuilderExtensions.ms_default_pad_char, false);
      return string_builder;
    }

    public static StringBuilder Concat(this StringBuilder string_builder, float float_val, uint decimal_places, uint pad_amount)
    {
      StringBuilderExtensions.Concat(string_builder, float_val, decimal_places, pad_amount, StringBuilderExtensions.ms_default_pad_char, false);
      return string_builder;
    }
    ...
    {
      StringBuilderExtensions.Concat(string_builder, double_val, StringBuilderExtensions.ms_default_decimal_places, 0U, StringBuilderExtensions.ms_default_pad_char, false);
      return string_builder;
    }

    public static StringBuilder Concat(this StringBuilder string_builder, double double_val, uint decimal_places)
    {
      StringBuilderExtensions.Concat(string_builder, double_val, decimal_places, 0U, StringBuilderExtensions.ms_default_pad_char, false);
      return string_builder;
    }
    ...
    {
      StringBuilderExtensions.Concat(string_builder, double_val, decimal_places, pad_amount, StringBuilderExtensions.ms_default_pad_char, false);
      return string_builder;
    }
    ...
    {
      sb.Clear();
      StringBuilderExtensions.ConcatFormat<string, long, string>(sb, "{0}{1: #,0}{2}", before, value, after, (NumberFormatInfo) null);
      return sb;
    }
    ...
    {
      sb.Clear();
      StringBuilderExtensions.ConcatFormat<string, int, string>(sb, "{0}{1: #,0}{2}", before, value, after, (NumberFormatInfo) null);
      return sb;
    }
    ...
    {
      sb.Clear();
      StringBuilderExtensions.ConcatFormat<string, float, string>(sb, "{0}{1: #,0}{2}", before, value, after, (NumberFormatInfo) null);
      return sb;
    }
    ...
    {
      sb.Clear();
      StringBuilderExtensions.ConcatFormat<string, bool, string>(sb, "{0}{1}{2}", before, value, after, (NumberFormatInfo) null);
      return sb;
    }
    ...
    {
      sb.Clear();
      StringBuilderExtensions.ConcatFormat<string, string, string>(sb, "{0}{1}{2}", before, value, after, (NumberFormatInfo) null);
      return sb;
    }
    ...
    public static StringBuilder AppendFormatedDecimal(this StringBuilder sb, string before, float value, int decimalDigits, string after = "")
    {
      ...
      StringBuilderExtensions.ConcatFormat<string, float, string>(sb, "{0}{1 }{2}", before, value, after, StringBuilderExtensions.m_numberFormatInfoHelper);
      return sb;
    }
    ...
    {
      return StringBuilderExtensions.AppendDecimal(sb, number, StringBuilderExtensions.GetDecimalCount(number, validDigitCount));
    }
    ...
    public static StringBuilder AppendDecimal(this StringBuilder sb, float number, int decimals)
    {
      ...
      StringBuilderExtensions.ConcatFormat<float>(sb, "{0}", number, StringBuilderExtensions.m_numberFormatInfoHelper);
      return sb;
    }
    ...
    {
      StringBuilderExtensions.m_numberFormatInfoHelper.NumberDecimalDigits = Math.Max(0, Math.Min(decimals, 99));
      StringBuilderExtensions.ConcatFormat<double>(sb, "{0}", number, StringBuilderExtensions.m_numberFormatInfoHelper);
      return sb;
    }
    ...
    public static StringBuilder TrimTrailingWhitespace(this StringBuilder sb)
    {
      ...
      while (length > 0 && (int) sb[length - 1] == 32 || ((int) sb[length - 1] == 13 || (int) sb[length - 1] == 10))
        --length;
      sb.Length = length;
      return sb;
    }
