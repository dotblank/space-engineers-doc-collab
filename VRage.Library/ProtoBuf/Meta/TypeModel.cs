...
namespace ProtoBuf.Meta
{
  public abstract class TypeModel
  {
    ...
    {
      int bytesRead;
      return this.DeserializeWithLengthPrefix(source, value, type, style, fieldNumber, (Serializer.TypeResolver) null, out bytesRead);
    }
    ...
    {
      bool haveObject;
      return this.DeserializeWithLengthPrefix(source, value, type, style, expectedField, resolver, out bytesRead, out haveObject, (SerializationContext) null);
    }
    ...
    public object DeepClone(object value)
    {
      ...
      if (key >= 0 && !Helpers.IsEnum(type))
      {
        using (MemoryStream memoryStream = new MemoryStream())
        {
          ...
          using (ProtoReader source = new ProtoReader((Stream) memoryStream, this, (SerializationContext) null))
      ...
      else
      {
        ...
        using (MemoryStream memoryStream = new MemoryStream())
        {
          ...
          memoryStream.Position = 0L;
          using (ProtoReader reader = new ProtoReader((Stream) memoryStream, this, (SerializationContext) null))
          {
            value = (object) null;
    ...
    private class DeserializeItemsIterator : IEnumerator, IEnumerable
    {
      ...
      public bool MoveNext()
      {
        ...
        {
          int bytesRead;
          this.current = this.model.DeserializeWithLengthPrefix(this.source, (object) null, this.type, this.style, this.expectedField, this.resolver, out bytesRead, out this.haveObject, this.context);
        }
