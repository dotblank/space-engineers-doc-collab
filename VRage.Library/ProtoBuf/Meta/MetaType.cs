...
namespace ProtoBuf.Meta
{
  public class MetaType : ISerializerProxy
  {
    ...
    IProtoSerializer ISerializerProxy.Serializer
    {
      get
      {
        return (IProtoSerializer) this.Serializer;
      }
    }
    ...
    public bool IncludeSerializerMethod
    {
      ...
      set
      {
        this.SetFlag((byte) 8, !value, true);
      }
    }
    ...
    public bool AsReferenceDefault
    {
      ...
      set
      {
        this.SetFlag((byte) 32, value, true);
      }
    }
    ...
    public bool UseConstructor
    {
      ...
      set
      {
        this.SetFlag((byte) 16, !value, true);
      }
    }
    ...
    public bool EnumPassthru
    {
      ...
      set
      {
        this.SetFlag((byte) 2, value, true);
      }
    }
    ...
    internal bool Pending
    {
      ...
      set
      {
        this.SetFlag((byte) 1, value, false);
      }
    }
    ...
    internal IEnumerable Fields
    {
      get
      {
        return (IEnumerable) this.fields;
      }
    }
    ...
    internal MetaType(RuntimeTypeModel model, Type type, MethodInfo factory)
    {
      ...
      if (ValueMember.TryGetCoreSerializer(model, DataFormat.Default, type, out defaultWireType, false, false, false, false) != null)
    ...
    internal string GetSchemaTypeName()
    {
      ...
      foreach (Type type1 in this.type.GetGenericArguments())
      {
        ...
        Type type2 = type1;
        MetaType metaType;
        if (((TypeModel) this.model).GetKey(ref type2) >= 0 && (metaType = this.model[type2]) != null && metaType.surrogate == (Type) null)
    ...
    internal void ApplyDefaultBehaviour()
    {
      ...
      for (int index = 0; index < attributes1.Length; ++index)
      {
        ...
        if (attributeMap.AttributeType.FullName == "System.Runtime.Serialization.DataContractAttribute" && str == null && attributeMap.TryGet("Name", out obj))
          str = (string) obj;
        if (attributeMap.AttributeType.FullName == "System.Xml.Serialization.XmlTypeAttribute" && str == null && attributeMap.TryGet("TypeName", out obj))
          str = (string) obj;
      }
        ...
        if (!(member.DeclaringType != this.type) && !member.IsDefined(this.model.MapType(typeof (ProtoIgnoreAttribute)), true) && (basicList == null || !basicList.Contains((object) member.Name)))
        {
          ...
          else
          {
            ...
            else
            {
              ...
              {
                AttributeMap[] attributes2 = AttributeMap.Create((TypeModel) this.model, (MemberInfo) method, false);
                if (attributes2 != null && attributes2.Length > 0)
                {
                  MetaType.CheckForCallback(method, attributes2, "ProtoBuf.ProtoBeforeSerializationAttribute", ref callbacks, 0);
                  MetaType.CheckForCallback(method, attributes2, "ProtoBuf.ProtoAfterSerializationAttribute", ref callbacks, 1);
                  MetaType.CheckForCallback(method, attributes2, "ProtoBuf.ProtoBeforeDeserializationAttribute", ref callbacks, 2);
                  MetaType.CheckForCallback(method, attributes2, "ProtoBuf.ProtoAfterDeserializationAttribute", ref callbacks, 3);
                  MetaType.CheckForCallback(method, attributes2, "System.Runtime.Serialization.OnSerializingAttribute", ref callbacks, 4);
                  MetaType.CheckForCallback(method, attributes2, "System.Runtime.Serialization.OnSerializedAttribute", ref callbacks, 5);
                  MetaType.CheckForCallback(method, attributes2, "System.Runtime.Serialization.OnDeserializingAttribute", ref callbacks, 6);
                  MetaType.CheckForCallback(method, attributes2, "System.Runtime.Serialization.OnDeserializedAttribute", ref callbacks, 7);
                }
              }
            }
          }
    ...
    internal static MetaType.AttributeFamily GetContractFamily(RuntimeTypeModel model, Type type, AttributeMap[] attributes)
    {
      ...
      MemberInfo[] mappedMembers;
      if (attributeFamily == MetaType.AttributeFamily.None && MetaType.ResolveTupleConstructor(type, out mappedMembers) != (ConstructorInfo) null)
      ...
      for (int index1 = 0; index1 < constructors.Length; ++index1)
      {
        ...
        if (parameters.Length == memberInfoArray.Length)
        {
          ...
          for (int index2 = 0; index2 < parameters.Length; ++index2)
          {
            ...
            {
              if (!(memberInfoArray[index3].Name.ToLower() != str) && !(Helpers.GetMemberType(memberInfoArray[index3]) != parameters[index2].ParameterType))
