...
namespace ProtoBuf.Meta
{
  public class ValueMember
  {
    ...
    public bool IsStrict
    {
      ...
      set
      {
        this.SetFlag((byte) 1, value, true);
      }
    }
    ...
    public bool IsRequired
    {
      ...
      set
      {
        this.SetFlag((byte) 4, value, true);
      }
    }
      ...
      if (value is string)
      {
        ...
        switch (Helpers.GetTypeCode(type))
        {
          ...
          case ProtoTypeCode.SByte:
            return (object) sbyte.Parse(str, NumberStyles.Integer, (IFormatProvider) CultureInfo.InvariantCulture);
          case ProtoTypeCode.Byte:
            return (object) byte.Parse(str, NumberStyles.Integer, (IFormatProvider) CultureInfo.InvariantCulture);
          case ProtoTypeCode.Int16:
            return (object) short.Parse(str, NumberStyles.Any, (IFormatProvider) CultureInfo.InvariantCulture);
          case ProtoTypeCode.UInt16:
            return (object) ushort.Parse(str, NumberStyles.Any, (IFormatProvider) CultureInfo.InvariantCulture);
          case ProtoTypeCode.Int32:
            return (object) int.Parse(str, NumberStyles.Any, (IFormatProvider) CultureInfo.InvariantCulture);
          case ProtoTypeCode.UInt32:
            return (object) uint.Parse(str, NumberStyles.Any, (IFormatProvider) CultureInfo.InvariantCulture);
          case ProtoTypeCode.Int64:
            return (object) long.Parse(str, NumberStyles.Any, (IFormatProvider) CultureInfo.InvariantCulture);
          case ProtoTypeCode.UInt64:
            return (object) ulong.Parse(str, NumberStyles.Any, (IFormatProvider) CultureInfo.InvariantCulture);
          case ProtoTypeCode.Single:
            return (object) float.Parse(str, NumberStyles.Any, (IFormatProvider) CultureInfo.InvariantCulture);
          case ProtoTypeCode.Double:
            return (object) double.Parse(str, NumberStyles.Any, (IFormatProvider) CultureInfo.InvariantCulture);
          case ProtoTypeCode.Decimal:
            return (object) Decimal.Parse(str, NumberStyles.Any, (IFormatProvider) CultureInfo.InvariantCulture);
    ...
    private IProtoSerializer BuildSerializer()
    {
      ...
      try
      {
        ...
        if (this.itemType != (Type) null)
        {
          ...
          tail = !this.memberType.IsArray ? (IProtoSerializer) new ListDecorator((TypeModel) this.model, this.memberType, this.defaultType, tail, this.fieldNumber, this.IsPacked, defaultWireType, this.member != (MemberInfo) null && PropertyDecorator.CanWrite((TypeModel) this.model, this.member), this.OverwriteList, this.SupportNull) : (IProtoSerializer) new ArrayDecorator((TypeModel) this.model, tail, this.fieldNumber, this.IsPacked, defaultWireType, this.memberType, this.OverwriteList, this.SupportNull);
        }
      ...
      else
      {
        switch (Helpers.GetTypeCode(type))
        {
          ...
          case ProtoTypeCode.String:
            defaultWireType = WireType.String;
            if (asReference)
              return (IProtoSerializer) new NetObjectSerializer((TypeModel) model, model.MapType(typeof (string)), 0, BclHelpers.NetObjectOptions.AsReference);
            else
          ...
          default:
            IProtoSerializer protoSerializer = model.AllowParseableTypes ? (IProtoSerializer) ParseableSerializer.TryCreate(type, (TypeModel) model) : (IProtoSerializer) null;
