  ...
  public static class BclHelpers
  {
    ...
    public static Decimal ReadDecimal(ProtoReader reader)
    {
      ...
      if ((long) num1 == 0L && (int) num2 == 0)
        ...
        return new Decimal((int) ((long) num1 & (long) uint.MaxValue), (int) ((long) (num1 >> 32) & (long) uint.MaxValue), (int) num2, ((int) num3 & 1) == 1, (byte) ((num3 & 510U) >> 1));
    }
      ...
      while ((num2 = source.ReadFieldHeader()) > 0)
      {
        switch (num2)
        {
          ...
          case 10:
            ...
            bool flag3 = flag2 && (flag1 || (options & BclHelpers.NetObjectOptions.LateSet) != BclHelpers.NetObjectOptions.None);
            if (num1 >= 0 && !flag3)
            {
              if (value == null)
            ...
            object objA = value;
            value = !flag1 ? ProtoReader.ReadTypedObject(objA, key, source, type) : (object) source.ReadString();
            if (num1 >= 0)
            {
              if (flag2 && !flag3)
