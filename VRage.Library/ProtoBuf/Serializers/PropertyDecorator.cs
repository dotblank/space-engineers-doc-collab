    ...
    internal sealed class PropertyDecorator : ProtoDecoratorBase
    {
            ...
            out bool writeValue, bool nonPublic, bool allowInternal)
        {
            ...
            writeValue = tail.ReturnsValue &&
                         (PropertyDecorator.GetShadowSetter(model, property) != (MethodInfo) null ||
                          property.CanWrite &&
                          Helpers.GetSetMethod(property, nonPublic, allowInternal) != (MethodInfo) null);
        ...
        {
            MethodInfo instanceMethod = Helpers.GetInstanceMethod(property.ReflectedType, "Set" + property.Name,
                new Type[1]
                {
                    property.PropertyType
                });
            if (instanceMethod == (MethodInfo) null || !instanceMethod.IsPublic ||
                instanceMethod.ReturnType != model.MapType(typeof (void)))
        ...
        public override object Read(object value, ProtoReader source)
        {
            object obj =
                this.Tail.Read(
                    this.Tail.RequiresOldValue ? this.property.GetValue(value, (object[]) null) : (object) null, source);
        ...
        {
            bool writeValue;
            PropertyDecorator.SanityCheck(ctx.Model, this.property, this.Tail, out writeValue, ctx.NonPublic,
