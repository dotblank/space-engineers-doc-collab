...
namespace ProtoBuf
{
  public static class Serializer
  {
    ...
    {
      return (T) ((ProtoBuf.Meta.TypeModel) RuntimeTypeModel.Default).Deserialize(source, (object) instance, typeof (T));
    }

    public static T Deserialize<T>(Stream source)
    {
      return (T) ((ProtoBuf.Meta.TypeModel) RuntimeTypeModel.Default).Deserialize(source, (object) null, typeof (T));
    }
    ...
    public static void Serialize<T>(SerializationInfo info, StreamingContext context, T instance) where T : class, ISerializable
    {
      ...
      using (MemoryStream memoryStream = new MemoryStream())
      {
        ((ProtoBuf.Meta.TypeModel) RuntimeTypeModel.Default).Serialize((Stream) memoryStream, (object) instance, (SerializationContext) context);
    ...
    public static void Merge<T>(SerializationInfo info, StreamingContext context, T instance) where T : class, ISerializable
    {
      ...
      {
        if (!object.ReferenceEquals((object) (T) ((ProtoBuf.Meta.TypeModel) RuntimeTypeModel.Default).Deserialize((Stream) memoryStream, (object) instance, typeof (T), (SerializationContext) context), (object) instance))
    ...
    {
      RuntimeTypeModel @default = RuntimeTypeModel.Default;
      return (T) @default.DeserializeWithLengthPrefix(source, (object) null, @default.MapType(typeof (T)), style, fieldNumber);
    }

    public static T MergeWithLengthPrefix<T>(Stream source, T instance, PrefixStyle style)
    {
      RuntimeTypeModel @default = RuntimeTypeModel.Default;
      return (T) @default.DeserializeWithLengthPrefix(source, (object) instance, @default.MapType(typeof (T)), style, 0);
    }
    ...
    {
      RuntimeTypeModel @default = RuntimeTypeModel.Default;
      @default.SerializeWithLengthPrefix(destination, (object) instance, @default.MapType(typeof (T)), style, fieldNumber);
    }
    ...
    public static class NonGeneric
    {
      ...
      public static object Merge(Stream source, object instance)
      {
        if (instance == null)
          ...
          return ((ProtoBuf.Meta.TypeModel) RuntimeTypeModel.Default).Deserialize(source, instance, instance.GetType(), (SerializationContext) null);
      }
